...
DOCUMENTATION = '''
---
module: fortios_system_probe-response
short_description: Configure system probe response.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and probe-response category.
...
def filter_system_probe-response_data(json):
...
def system_probe-response(data, fos):
    vdom = data['vdom']
    system_probe-response_data = data['system_probe-response']
    filtered_data = filter_system_probe - \
        response_data(system_probe-response_data)

    if system_probe-response_data['state'] == "present":
        return fos.set('system',
                       'probe-response',
                       data=filtered_data,
                       vdom=vdom)

    elif system_probe-response_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_probe-response']
