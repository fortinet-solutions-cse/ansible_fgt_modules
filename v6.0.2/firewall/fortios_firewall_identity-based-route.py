...
DOCUMENTATION = '''
---
module: fortios_firewall_identity-based-route
short_description: Configure identity based routing.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure firewall feature and identity-based-route category.
...
- hosts: localhost
  ...
  - name: Configure identity based routing.
    fortios_firewall_identity-based-route:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_firewall_identity-based-route_data(json):
...
def firewall_identity-based-route(data, fos):
    vdom = data['vdom']
    firewall_identity-based-route_data = data['firewall_identity-based-route']
    filtered_data = filter_firewall_identity-based - \
        route_data(firewall_identity-based-route_data)

    if firewall_identity-based-route_data['state'] == "present":
        return fos.set('firewall',
                       'identity-based-route',
                       data=filtered_data,
                       vdom=vdom)

    elif firewall_identity-based-route_data['state'] == "absent":
...
def fortios_firewall(data, fos):
    ...
    methodlist = ['firewall_identity-based-route']
