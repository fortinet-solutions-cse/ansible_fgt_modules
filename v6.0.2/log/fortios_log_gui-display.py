...
DOCUMENTATION = '''
---
module: fortios_log_gui-display
short_description: Configure how log messages are displayed on the GUI.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure log feature and gui-display category.
...
def filter_log_gui-display_data(json):
...
def log_gui-display(data, fos):
    vdom = data['vdom']
    log_gui-display_data = data['log_gui-display']
    filtered_data = filter_log_gui-display_data(log_gui-display_data)

    if log_gui-display_data['state'] == "present":
        return fos.set('log',
                       'gui-display',
                       data=filtered_data,
                       vdom=vdom)

    elif log_gui-display_data['state'] == "absent":
