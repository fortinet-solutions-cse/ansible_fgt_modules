...
def log.fortianalyzer2_filter(data, fos):
    ...
    filtered_data = filter_log.fortianalyzer2_filter_data(log.fortianalyzer2_filter_data)
...
def main():
    ...
    is_error, has_changed, result = fortios_log.fortianalyzer2(module.params, fos)
