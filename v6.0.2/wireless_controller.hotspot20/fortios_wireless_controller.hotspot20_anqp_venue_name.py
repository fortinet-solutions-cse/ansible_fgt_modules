...
def filter_wireless_controller.hotspot20_anqp_venue_name_data(json):
...
def wireless_controller.hotspot20_anqp_venue_name(data, fos):
    ...
    elif wireless_controller.hotspot20_anqp_venue_name_data['state'] == "absent":
...
def fortios_wireless_controller.hotspot20(data, fos):
    ...
    methodlist = ['wireless_controller.hotspot20_anqp_venue_name']
