...
def system_vdom_netflow(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(system_vdom_netflow_data)
    filtered_data = filter_system_vdom_netflow_data(flattened_data)
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_vdom_netflow']
