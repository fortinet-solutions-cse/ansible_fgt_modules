...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure switch_controller feature and mac_sync_settings category.
...
def switch_controller_mac_sync_settings(data, fos):
    ...
    filtered_data = filter_switch_controller_mac_sync_settings_data(switch_controller_mac_sync_settings_data)
...
def fortios_switch_controller(data, fos):
    ...
    methodlist = ['switch_controller_mac_sync_settings']
