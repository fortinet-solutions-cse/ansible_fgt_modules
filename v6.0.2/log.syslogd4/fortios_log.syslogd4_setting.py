...
def filter_log.syslogd4_setting_data(json):
...
def log.syslogd4_setting(data, fos):
    vdom = data['vdom']
    log.syslogd4_setting_data = data['log.syslogd4_setting']
    filtered_data = filter_log.syslogd4_setting_data(log.syslogd4_setting_data)

    if log.syslogd4_setting_data['state'] == "present":
        return fos.set('log.syslogd4',
                       'setting',
                       data=filtered_data,
                       vdom=vdom)

    elif log.syslogd4_setting_data['state'] == "absent":
...
def fortios_log.syslogd4(data, fos):
    ...
    methodlist = ['log.syslogd4_setting']
