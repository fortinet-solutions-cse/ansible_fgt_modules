...
def switch_controller_storm_control(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(switch_controller_storm_control_data)
    filtered_data = filter_switch_controller_storm_control_data(flattened_data)
