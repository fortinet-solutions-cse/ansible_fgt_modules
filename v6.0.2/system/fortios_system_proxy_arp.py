...
def system_proxy_arp(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(system_proxy_arp_data)
    filtered_data = filter_system_proxy_arp_data(flattened_data)
    if system_proxy_arp_data['state'] == "present":
        return fos.set('system',
                       'proxy-arp',
                       data=filtered_data,
                       vdom=vdom)

    elif system_proxy_arp_data['state'] == "absent":
