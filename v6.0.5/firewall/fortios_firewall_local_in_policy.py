...
short_description: Configure user defined IPv4 local_in policies in Fortinet's FortiOS and FortiGate.
description:
...
options:
    ...
    firewall_local_in_policy:
        description:
            - Configure user defined IPv4 local_in policies.
        default: null
        type: dict
        suboptions:
            action:
...
- hosts: localhost
  vars:
   ...
   ssl_verify: "False"
  tasks:
  - name: Configure user defined IPv4 local_in policies.
