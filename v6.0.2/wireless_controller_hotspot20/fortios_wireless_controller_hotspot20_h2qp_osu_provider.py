...
def wireless_controller_hotspot20_h2qp_osu_provider(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(wireless_controller_hotspot20_h2qp_osu_provider_data)
    filtered_data = filter_wireless_controller_hotspot20_h2qp_osu_provider_data(flattened_data)
