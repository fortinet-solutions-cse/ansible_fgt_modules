...
DOCUMENTATION = '''
---
module: fortios_system_replacemsg-group
short_description: Configure replacement message groups.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and replacemsg-group category.
...
- hosts: localhost
  ...
  - name: Configure replacement message groups.
    fortios_system_replacemsg-group:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_system_replacemsg-group_data(json):
...
def system_replacemsg-group(data, fos):
    vdom = data['vdom']
    system_replacemsg-group_data = data['system_replacemsg-group']
    filtered_data = filter_system_replacemsg - \
        group_data(system_replacemsg-group_data)

    if system_replacemsg-group_data['state'] == "present":
        return fos.set('system',
                       'replacemsg-group',
                       data=filtered_data,
                       vdom=vdom)

    elif system_replacemsg-group_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_replacemsg-group']
