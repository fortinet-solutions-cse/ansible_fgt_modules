...
def log_fortianalyzer_override_setting(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(log_fortianalyzer_override_setting_data)
    filtered_data = filter_log_fortianalyzer_override_setting_data(flattened_data)
