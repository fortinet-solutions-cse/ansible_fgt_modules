...
def system_replacemsg_spam(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(system_replacemsg_spam_data)
    filtered_data = filter_system_replacemsg_spam_data(flattened_data)
    if system_replacemsg_spam_data['state'] == "present":
        return fos.set('system.replacemsg',
                       'spam',
                       data=filtered_data,
                       vdom=vdom)

    elif system_replacemsg_spam_data['state'] == "absent":
...
def fortios_system_replacemsg(data, fos):
    ...
    methodlist = ['system_replacemsg_spam']
