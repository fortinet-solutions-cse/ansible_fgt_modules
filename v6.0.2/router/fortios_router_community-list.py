...
DOCUMENTATION = '''
---
module: fortios_router_community-list
short_description: Configure community lists.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure router feature and community-list category.
...
def filter_router_community-list_data(json):
...
def router_community-list(data, fos):
    vdom = data['vdom']
    router_community-list_data = data['router_community-list']
    filtered_data = filter_router_community - \
        list_data(router_community-list_data)

    if router_community-list_data['state'] == "present":
        return fos.set('router',
                       'community-list',
                       data=filtered_data,
                       vdom=vdom)

    elif router_community-list_data['state'] == "absent":
...
def fortios_router(data, fos):
    ...
    methodlist = ['router_community-list']
