...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system_autoupdate feature and tunneling category.
...
def system_autoupdate_tunneling(data, fos):
    ...
    filtered_data = filter_system_autoupdate_tunneling_data(system_autoupdate_tunneling_data)
