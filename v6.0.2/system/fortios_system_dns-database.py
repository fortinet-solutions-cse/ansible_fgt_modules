...
DOCUMENTATION = '''
---
module: fortios_system_dns-database
short_description: Configure DNS databases.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and dns-database category.
...
def filter_system_dns-database_data(json):
...
def system_dns-database(data, fos):
    vdom = data['vdom']
    system_dns-database_data = data['system_dns-database']
    filtered_data = filter_system_dns-database_data(system_dns-database_data)

    if system_dns-database_data['state'] == "present":
        return fos.set('system',
                       'dns-database',
                       data=filtered_data,
                       vdom=vdom)

    elif system_dns-database_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_dns-database']
    ...
    fields = {
        ...
        "system_dns-database": {
            ...
            "options": {
                ...
                "ip-master": {"required": False, "type": "ipv4-address-any"},
