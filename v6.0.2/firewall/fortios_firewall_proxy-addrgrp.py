...
DOCUMENTATION = '''
---
module: fortios_firewall_proxy-addrgrp
short_description: Web proxy address group configuration.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure firewall feature and proxy-addrgrp category.
...
- hosts: localhost
  ...
  - name: Web proxy address group configuration.
    fortios_firewall_proxy-addrgrp:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_firewall_proxy-addrgrp_data(json):
...
def firewall_proxy-addrgrp(data, fos):
    vdom = data['vdom']
    firewall_proxy-addrgrp_data = data['firewall_proxy-addrgrp']
    filtered_data = filter_firewall_proxy - \
        addrgrp_data(firewall_proxy-addrgrp_data)

    if firewall_proxy-addrgrp_data['state'] == "present":
        return fos.set('firewall',
                       'proxy-addrgrp',
                       data=filtered_data,
                       vdom=vdom)

    elif firewall_proxy-addrgrp_data['state'] == "absent":
...
def fortios_firewall(data, fos):
    ...
    methodlist = ['firewall_proxy-addrgrp']
