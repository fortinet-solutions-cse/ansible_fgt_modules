...
DOCUMENTATION = '''
---
module: fortios_router_prefix-list6
short_description: Configure IPv6 prefix lists.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure router feature and prefix-list6 category.
...
def filter_router_prefix-list6_data(json):
...
def router_prefix-list6(data, fos):
    vdom = data['vdom']
    router_prefix-list6_data = data['router_prefix-list6']
    filtered_data = filter_router_prefix-list6_data(router_prefix-list6_data)

    if router_prefix-list6_data['state'] == "present":
        return fos.set('router',
                       'prefix-list6',
                       data=filtered_data,
                       vdom=vdom)

    elif router_prefix-list6_data['state'] == "absent":
...
def fortios_router(data, fos):
    ...
    methodlist = ['router_prefix-list6']
