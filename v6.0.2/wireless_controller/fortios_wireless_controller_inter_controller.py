...
def wireless_controller_inter_controller(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(wireless_controller_inter_controller_data)
    filtered_data = filter_wireless_controller_inter_controller_data(flattened_data)
