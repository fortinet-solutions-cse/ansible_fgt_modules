...
DOCUMENTATION = '''
---
module: fortios_system_network-visibility
short_description: Configure network visibility settings.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and network-visibility category.
...
- hosts: localhost
  ...
  - name: Configure network visibility settings.
    fortios_system_network-visibility:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_system_network-visibility_data(json):
...
def system_network-visibility(data, fos):
    vdom = data['vdom']
    system_network-visibility_data = data['system_network-visibility']
    filtered_data = filter_system_network - \
        visibility_data(system_network-visibility_data)

    if system_network-visibility_data['state'] == "present":
        return fos.set('system',
                       'network-visibility',
                       data=filtered_data,
                       vdom=vdom)

    elif system_network-visibility_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_network-visibility']
