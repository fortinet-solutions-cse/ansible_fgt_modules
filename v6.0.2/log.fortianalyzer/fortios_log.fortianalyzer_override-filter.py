...
DOCUMENTATION = '''
---
module: fortios_log.fortianalyzer_override-filter
short_description: Override filters for FortiAnalyzer.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure log.fortianalyzer feature and override-filter category.
...
- hosts: localhost
  ...
  - name: Override filters for FortiAnalyzer.
    fortios_log.fortianalyzer_override-filter:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_log.fortianalyzer_override-filter_data(json):
...
def log.fortianalyzer_override-filter(data, fos):
    vdom = data['vdom']
    log.fortianalyzer_override-filter_data = data['log.fortianalyzer_override-filter']
    filtered_data = filter_log.fortianalyzer_override - \
        filter_data(log.fortianalyzer_override-filter_data)

    if log.fortianalyzer_override-filter_data['state'] == "present":
        return fos.set('log.fortianalyzer',
                       'override-filter',
                       data=filtered_data,
                       vdom=vdom)

    elif log.fortianalyzer_override-filter_data['state'] == "absent":
...
def fortios_log.fortianalyzer(data, fos):
    ...
    methodlist = ['log.fortianalyzer_override-filter']
