...
DOCUMENTATION = '''
---
module: fortios_firewall_DoS-policy
short_description: Configure IPv4 DoS policies.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure firewall feature and DoS-policy category.
...
def filter_firewall_DoS-policy_data(json):
...
def firewall_DoS-policy(data, fos):
    vdom = data['vdom']
    firewall_DoS-policy_data = data['firewall_DoS-policy']
    filtered_data = filter_firewall_DoS-policy_data(firewall_DoS-policy_data)

    if firewall_DoS-policy_data['state'] == "present":
        return fos.set('firewall',
                       'DoS-policy',
                       data=filtered_data,
                       vdom=vdom)

    elif firewall_DoS-policy_data['state'] == "absent":
...
def fortios_firewall(data, fos):
    ...
    methodlist = ['firewall_DoS-policy']
