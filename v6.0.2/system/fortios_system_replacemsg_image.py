...
def system_replacemsg_image(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(system_replacemsg_image_data)
    filtered_data = filter_system_replacemsg_image_data(flattened_data)
    ...
    elif system_replacemsg_image_data['state'] == "absent":
