...
DOCUMENTATION = '''
---
module: fortios_system_gre-tunnel
short_description: Configure GRE tunnel.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and gre-tunnel category.
...
def filter_system_gre-tunnel_data(json):
...
def system_gre-tunnel(data, fos):
    vdom = data['vdom']
    system_gre-tunnel_data = data['system_gre-tunnel']
    filtered_data = filter_system_gre-tunnel_data(system_gre-tunnel_data)

    if system_gre-tunnel_data['state'] == "present":
        return fos.set('system',
                       'gre-tunnel',
                       data=filtered_data,
                       vdom=vdom)

    elif system_gre-tunnel_data['state'] == "absent":
