...
def system_custom_language(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(system_custom_language_data)
    filtered_data = filter_system_custom_language_data(flattened_data)
    ...
    elif system_custom_language_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_custom_language']
