...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure wireless_controller_hotspot20 feature and anqp_ip_address_type category.
...
def wireless_controller_hotspot20_anqp_ip_address_type(data, fos):
    ...
    filtered_data = filter_wireless_controller_hotspot20_anqp_ip_address_type_data(wireless_controller_hotspot20_anqp_ip_address_type_data)
