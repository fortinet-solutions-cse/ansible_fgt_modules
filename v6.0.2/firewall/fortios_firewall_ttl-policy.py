...
DOCUMENTATION = '''
---
module: fortios_firewall_ttl-policy
short_description: Configure TTL policies.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure firewall feature and ttl-policy category.
...
def filter_firewall_ttl-policy_data(json):
...
def firewall_ttl-policy(data, fos):
    vdom = data['vdom']
    firewall_ttl-policy_data = data['firewall_ttl-policy']
    filtered_data = filter_firewall_ttl-policy_data(firewall_ttl-policy_data)

    if firewall_ttl-policy_data['state'] == "present":
        return fos.set('firewall',
                       'ttl-policy',
                       data=filtered_data,
                       vdom=vdom)

    elif firewall_ttl-policy_data['state'] == "absent":
...
def fortios_firewall(data, fos):
    ...
    methodlist = ['firewall_ttl-policy']
