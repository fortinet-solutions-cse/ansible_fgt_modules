...
def filter_system_dscp_based_priority_data(json):
...
def system_dscp_based_priority(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(system_dscp_based_priority_data)
    filtered_data = filter_system_dscp_based_priority_data(flattened_data)
    ...
    elif system_dscp_based_priority_data['state'] == "absent":
