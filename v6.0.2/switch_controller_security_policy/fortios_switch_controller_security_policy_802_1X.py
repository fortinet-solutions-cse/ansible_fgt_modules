...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure switch_controller_security_policy feature and 802_1X category.
...
def switch_controller_security_policy_802_1X(data, fos):
    ...
    filtered_data = filter_switch_controller_security_policy_802_1X_data(switch_controller_security_policy_802_1X_data)
    if switch_controller_security_policy_802_1X_data['state'] == "present":
        return fos.set('switch-controller.security-policy',
                       '802-1X',
                       data=filtered_data,
                       vdom=vdom)

    elif switch_controller_security_policy_802_1X_data['state'] == "absent":
