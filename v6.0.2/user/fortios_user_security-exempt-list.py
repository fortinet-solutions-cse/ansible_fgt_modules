...
DOCUMENTATION = '''
---
module: fortios_user_security-exempt-list
short_description: Configure security exemption list.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure user feature and security-exempt-list category.
...
- hosts: localhost
  ...
  - name: Configure security exemption list.
    fortios_user_security-exempt-list:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_user_security-exempt-list_data(json):
...
def user_security-exempt-list(data, fos):
    vdom = data['vdom']
    user_security-exempt-list_data = data['user_security-exempt-list']
    filtered_data = filter_user_security-exempt - \
        list_data(user_security-exempt-list_data)

    if user_security-exempt-list_data['state'] == "present":
        return fos.set('user',
                       'security-exempt-list',
                       data=filtered_data,
                       vdom=vdom)

    elif user_security-exempt-list_data['state'] == "absent":
...
def fortios_user(data, fos):
    ...
    methodlist = ['user_security-exempt-list']
