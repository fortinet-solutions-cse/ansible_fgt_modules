...
DOCUMENTATION = '''
---
module: fortios_system_automation-action
short_description: Action for automation stitches.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and automation-action category.
...
- hosts: localhost
  ...
  - name: Action for automation stitches.
    fortios_system_automation-action:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_system_automation-action_data(json):
...
def system_automation-action(data, fos):
    vdom = data['vdom']
    system_automation-action_data = data['system_automation-action']
    filtered_data = filter_system_automation - \
        action_data(system_automation-action_data)

    if system_automation-action_data['state'] == "present":
        return fos.set('system',
                       'automation-action',
                       data=filtered_data,
                       vdom=vdom)

    elif system_automation-action_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_automation-action']
