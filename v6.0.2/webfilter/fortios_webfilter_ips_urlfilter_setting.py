...
def webfilter_ips_urlfilter_setting(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(webfilter_ips_urlfilter_setting_data)
    filtered_data = filter_webfilter_ips_urlfilter_setting_data(flattened_data)
