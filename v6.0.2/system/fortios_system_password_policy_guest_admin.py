...
def system_password_policy_guest_admin(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(system_password_policy_guest_admin_data)
    filtered_data = filter_system_password_policy_guest_admin_data(flattened_data)
