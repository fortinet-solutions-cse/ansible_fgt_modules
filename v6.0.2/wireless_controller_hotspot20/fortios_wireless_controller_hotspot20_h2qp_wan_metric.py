...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure wireless_controller_hotspot20 feature and h2qp_wan_metric category.
...
def wireless_controller_hotspot20_h2qp_wan_metric(data, fos):
    ...
    filtered_data = filter_wireless_controller_hotspot20_h2qp_wan_metric_data(wireless_controller_hotspot20_h2qp_wan_metric_data)
    if wireless_controller_hotspot20_h2qp_wan_metric_data['state'] == "present":
        return fos.set('wireless-controller.hotspot20',
                       'h2qp-wan-metric',
                       data=filtered_data,
                       vdom=vdom)

    elif wireless_controller_hotspot20_h2qp_wan_metric_data['state'] == "absent":
