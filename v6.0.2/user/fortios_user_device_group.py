...
description:
    - This module is able to configure a FortiGate or FortiOS by allowing the
      user to set and modify user feature and device_group category.
...
def user_device_group(data, fos):
    vdom = data['vdom']
    user_device_group_data = data['user_device_group']
    flattened_data = flatten_multilists_attributes(user_device_group_data)
    filtered_data = filter_user_device_group_data(flattened_data)
    if user_device_group_data['state'] == "present":
        return fos.set('user',
                       'device-group',
                       data=filtered_data,
                       vdom=vdom)

    elif user_device_group_data['state'] == "absent":
...
def fortios_user(data, fos):
    ...
    if data['user_device_group']:
        resp = user_device_group(data, fos)
