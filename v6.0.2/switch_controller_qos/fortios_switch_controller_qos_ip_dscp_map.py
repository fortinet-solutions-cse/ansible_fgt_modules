...
def switch_controller_qos_ip_dscp_map(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(switch_controller_qos_ip_dscp_map_data)
    filtered_data = filter_switch_controller_qos_ip_dscp_map_data(flattened_data)
...
def fortios_switch_controller_qos(data, fos):
    ...
    methodlist = ['switch_controller_qos_ip_dscp_map']
