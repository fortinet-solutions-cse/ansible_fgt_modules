...
DOCUMENTATION = '''
---
module: fortios_wireless-controller_wtp-profile
...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure wireless-controller feature and wtp-profile category.
...
- hosts: localhost
  ...
  - name: Configure WTP profiles or FortiAP profiles that define radio settings for manageable FortiAP platforms.
    fortios_wireless-controller_wtp-profile:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_wireless-controller_wtp-profile_data(json):
...
def wireless-controller_wtp-profile(data, fos):
    vdom = data['vdom']
    wireless-controller_wtp-profile_data = data['wireless-controller_wtp-profile']
    filtered_data = filter_wireless-controller_wtp - \
        profile_data(wireless-controller_wtp-profile_data)

    if wireless-controller_wtp-profile_data['state'] == "present":
        return fos.set('wireless-controller',
                       'wtp-profile',
                       data=filtered_data,
                       vdom=vdom)

    elif wireless-controller_wtp-profile_data['state'] == "absent":
...
def fortios_wireless-controller(data, fos):
    ...
    methodlist = ['wireless-controller_wtp-profile']
            ...
            "options": {
                ...
                "lbs": {"required": False, "type": "dict",
                        "options": {
                            ...
                            "aeroscout-server-ip": {"required": False, "type": "ipv4-address-any"},
                            "aeroscout-server-port": {"required": False, "type": "int"},
                            "ekahau-blink-mode": {"required": False, "type": "str",
                                                  "choices": ["enable", "disable"]},
                            "ekahau-tag": {"required": False, "type": "mac-address"},
                            "erc-server-ip": {"required": False, "type": "ipv4-address-any"},
                            ...
                            "fortipresence-rogue": {"required": False, "type": "str",
                                                    "choices": ["enable", "disable"]},
                            "fortipresence-secret": {"required": False, "type": "password"},
                            "fortipresence-server": {"required": False, "type": "ipv4-address-any"},
                ...
                "lldp": {"required": False, "type": "str",
                         "choices": ["enable", "disable"]},
                "login-passwd": {"required": False, "type": "password"},
                ...
                "radio-1": {"required": False, "type": "dict",
                            "options": {
                                ...
                                "ap-handoff": {"required": False, "type": "str",
                                               "choices": ["enable", "disable"]},
                                "ap-sniffer-addr": {"required": False, "type": "mac-address"},
                ...
                "split-tunneling-acl": {"required": False, "type": "list",
                                        "options": {
                                            "dest-ip": {"required": False, "type": "ipv4-classnet"},
                                            "id": {"required": True, "type": "int"}
                                        }},
