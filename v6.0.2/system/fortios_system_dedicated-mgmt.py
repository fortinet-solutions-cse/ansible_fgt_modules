...
DOCUMENTATION = '''
---
module: fortios_system_dedicated-mgmt
short_description: Configure dedicated management.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and dedicated-mgmt category.
...
def filter_system_dedicated-mgmt_data(json):
...
def system_dedicated-mgmt(data, fos):
    vdom = data['vdom']
    system_dedicated-mgmt_data = data['system_dedicated-mgmt']
    filtered_data = filter_system_dedicated - \
        mgmt_data(system_dedicated-mgmt_data)

    if system_dedicated-mgmt_data['state'] == "present":
        return fos.set('system',
                       'dedicated-mgmt',
                       data=filtered_data,
                       vdom=vdom)

    elif system_dedicated-mgmt_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_dedicated-mgmt']
    ...
    fields = {
        ...
        "system_dedicated-mgmt": {
            ...
            "options": {
                ...
                "dhcp-end-ip": {"required": False, "type": "ipv4-address"},
                "dhcp-netmask": {"required": False, "type": "ipv4-netmask"},
                "dhcp-server": {"required": False, "type": "str",
                                "choices": ["enable", "disable"]},
                "dhcp-start-ip": {"required": False, "type": "ipv4-address"},
