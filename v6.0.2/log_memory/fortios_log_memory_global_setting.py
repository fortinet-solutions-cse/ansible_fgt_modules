...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure log_memory feature and global_setting category.
...
def log_memory_global_setting(data, fos):
    ...
    filtered_data = filter_log_memory_global_setting_data(log_memory_global_setting_data)
...
def fortios_log_memory(data, fos):
    ...
    methodlist = ['log_memory_global_setting']
