...
def wireless_controller_hotspot20_anqp_venue_name(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(wireless_controller_hotspot20_anqp_venue_name_data)
    filtered_data = filter_wireless_controller_hotspot20_anqp_venue_name_data(flattened_data)
...
def fortios_wireless_controller_hotspot20(data, fos):
    ...
    methodlist = ['wireless_controller_hotspot20_anqp_venue_name']
