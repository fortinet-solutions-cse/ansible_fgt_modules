...
def system_replacemsg_icap(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(system_replacemsg_icap_data)
    filtered_data = filter_system_replacemsg_icap_data(flattened_data)
    if system_replacemsg_icap_data['state'] == "present":
        return fos.set('system.replacemsg',
                       'icap',
                       data=filtered_data,
                       vdom=vdom)

    elif system_replacemsg_icap_data['state'] == "absent":
...
def fortios_system_replacemsg(data, fos):
    ...
    methodlist = ['system_replacemsg_icap']
