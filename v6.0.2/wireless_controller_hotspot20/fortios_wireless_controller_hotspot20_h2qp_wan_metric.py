...
def wireless_controller_hotspot20_h2qp_wan_metric(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(wireless_controller_hotspot20_h2qp_wan_metric_data)
    filtered_data = filter_wireless_controller_hotspot20_h2qp_wan_metric_data(flattened_data)
