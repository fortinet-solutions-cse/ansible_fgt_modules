...
def switch_controller_virtual_port_pool(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(switch_controller_virtual_port_pool_data)
    filtered_data = filter_switch_controller_virtual_port_pool_data(flattened_data)
...
def fortios_switch_controller(data, fos):
    ...
    if data['switch_controller_virtual_port_pool']:
        resp = switch_controller_virtual_port_pool(data, fos)
