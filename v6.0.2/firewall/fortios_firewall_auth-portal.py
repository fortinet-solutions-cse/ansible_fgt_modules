...
DOCUMENTATION = '''
---
module: fortios_firewall_auth-portal
short_description: Configure firewall authentication portals.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure firewall feature and auth-portal category.
...
def filter_firewall_auth-portal_data(json):
...
def firewall_auth-portal(data, fos):
    vdom = data['vdom']
    firewall_auth-portal_data = data['firewall_auth-portal']
    filtered_data = filter_firewall_auth-portal_data(firewall_auth-portal_data)

    if firewall_auth-portal_data['state'] == "present":
        return fos.set('firewall',
                       'auth-portal',
                       data=filtered_data,
                       vdom=vdom)

    elif firewall_auth-portal_data['state'] == "absent":
...
def fortios_firewall(data, fos):
    ...
    methodlist = ['firewall_auth-portal']
