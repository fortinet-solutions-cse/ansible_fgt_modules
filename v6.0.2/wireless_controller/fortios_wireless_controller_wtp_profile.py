...
def wireless_controller_wtp_profile(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(wireless_controller_wtp_profile_data)
    filtered_data = filter_wireless_controller_wtp_profile_data(flattened_data)
