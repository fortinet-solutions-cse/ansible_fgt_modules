...
def filter_log.fortiguard_filter_data(json):
...
def log.fortiguard_filter(data, fos):
    ...
    if log.fortiguard_filter_data['state'] == "present":
        return fos.set('log.fortiguard',
                       'filter',
                       data=filtered_data,
                       vdom=vdom)

    elif log.fortiguard_filter_data['state'] == "absent":
...
def fortios_log.fortiguard(data, fos):
    ...
    methodlist = ['log.fortiguard_filter']
