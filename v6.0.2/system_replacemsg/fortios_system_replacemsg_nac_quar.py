...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system_replacemsg feature and nac_quar category.
...
def system_replacemsg_nac_quar(data, fos):
    ...
    filtered_data = filter_system_replacemsg_nac_quar_data(system_replacemsg_nac_quar_data)
    if system_replacemsg_nac_quar_data['state'] == "present":
        return fos.set('system.replacemsg',
                       'nac-quar',
                       data=filtered_data,
                       vdom=vdom)

    elif system_replacemsg_nac_quar_data['state'] == "absent":
...
def fortios_system_replacemsg(data, fos):
    ...
    methodlist = ['system_replacemsg_nac_quar']
