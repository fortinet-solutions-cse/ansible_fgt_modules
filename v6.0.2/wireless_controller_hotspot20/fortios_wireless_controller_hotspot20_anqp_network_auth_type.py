...
def wireless_controller_hotspot20_anqp_network_auth_type(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(wireless_controller_hotspot20_anqp_network_auth_type_data)
    filtered_data = filter_wireless_controller_hotspot20_anqp_network_auth_type_data(flattened_data)
