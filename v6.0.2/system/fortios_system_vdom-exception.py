...
DOCUMENTATION = '''
---
module: fortios_system_vdom-exception
...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and vdom-exception category.
...
def filter_system_vdom-exception_data(json):
...
def system_vdom-exception(data, fos):
    vdom = data['vdom']
    system_vdom-exception_data = data['system_vdom-exception']
    filtered_data = filter_system_vdom - \
        exception_data(system_vdom-exception_data)

    if system_vdom-exception_data['state'] == "present":
        return fos.set('system',
                       'vdom-exception',
                       data=filtered_data,
                       vdom=vdom)

    elif system_vdom-exception_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_vdom-exception']
