...
DOCUMENTATION = '''
---
module: fortios_wanopt_auth-group
short_description: Configure WAN optimization authentication groups.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure wanopt feature and auth-group category.
...
def filter_wanopt_auth-group_data(json):
...
def wanopt_auth-group(data, fos):
    vdom = data['vdom']
    wanopt_auth-group_data = data['wanopt_auth-group']
    filtered_data = filter_wanopt_auth-group_data(wanopt_auth-group_data)

    if wanopt_auth-group_data['state'] == "present":
        return fos.set('wanopt',
                       'auth-group',
                       data=filtered_data,
                       vdom=vdom)

    elif wanopt_auth-group_data['state'] == "absent":
    ...
    fields = {
        ...
        "wanopt_auth-group": {
            ...
            "options": {
                ...
                "psk": {"required": False, "type": "password"}
