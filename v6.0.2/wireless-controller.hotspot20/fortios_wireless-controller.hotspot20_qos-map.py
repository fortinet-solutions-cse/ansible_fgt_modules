...
DOCUMENTATION = '''
---
module: fortios_wireless-controller.hotspot20_qos-map
short_description: Configure QoS map set.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure wireless-controller.hotspot20 feature and qos-map category.
...
- hosts: localhost
  ...
  - name: Configure QoS map set.
    fortios_wireless-controller.hotspot20_qos-map:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_wireless-controller.hotspot20_qos-map_data(json):
...
def wireless-controller.hotspot20_qos-map(data, fos):
    vdom = data['vdom']
    wireless-controller.hotspot20_qos-map_data = data['wireless-controller.hotspot20_qos-map']
    filtered_data = filter_wireless-controller.hotspot20_qos - \
        map_data(wireless-controller.hotspot20_qos-map_data)

    if wireless-controller.hotspot20_qos-map_data['state'] == "present":
        return fos.set('wireless-controller.hotspot20',
                       'qos-map',
                       data=filtered_data,
                       vdom=vdom)

    elif wireless-controller.hotspot20_qos-map_data['state'] == "absent":
...
def fortios_wireless-controller.hotspot20(data, fos):
    ...
    methodlist = ['wireless-controller.hotspot20_qos-map']
