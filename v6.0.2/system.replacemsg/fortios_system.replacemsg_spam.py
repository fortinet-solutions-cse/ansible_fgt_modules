...
DOCUMENTATION = '''
---
module: fortios_system.replacemsg_spam
short_description: Replacement messages in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system.replacemsg feature and spam category.
...
def filter_system.replacemsg_spam_data(json):
...
def system.replacemsg_spam(data, fos):
    vdom = data['vdom']
    system.replacemsg_spam_data = data['system.replacemsg_spam']
    filtered_data = filter_system.replacemsg_spam_data(system.replacemsg_spam_data)
    if system.replacemsg_spam_data['state'] == "present":
        return fos.set('system.replacemsg',
                       'spam',
                       data=filtered_data,
                       vdom=vdom)

    elif system.replacemsg_spam_data['state'] == "absent":
...
def fortios_system.replacemsg(data, fos):
    ...
    methodlist = ['system.replacemsg_spam']
