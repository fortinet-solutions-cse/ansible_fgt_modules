...
DOCUMENTATION = '''
---
module: fortios_system_api-user
short_description: Configure API users.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and api-user category.
...
def filter_system_api-user_data(json):
...
def system_api-user(data, fos):
    vdom = data['vdom']
    system_api-user_data = data['system_api-user']
    filtered_data = filter_system_api-user_data(system_api-user_data)

    if system_api-user_data['state'] == "present":
        return fos.set('system',
                       'api-user',
                       data=filtered_data,
                       vdom=vdom)

    elif system_api-user_data['state'] == "absent":
            ...
            "options": {
                ...
                "trusthost": {"required": False, "type": "list",
                              "options": {
                                  ...
                                  "ipv4-trusthost": {"required": False, "type": "ipv4-classnet"},
                                  "ipv6-trusthost": {"required": False, "type": "ipv6-prefix"},
