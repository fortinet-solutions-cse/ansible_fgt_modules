...
DOCUMENTATION = '''
---
module: fortios_system_automation-stitch
short_description: Automation stitches.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and automation-stitch category.
...
- hosts: localhost
  ...
  - name: Automation stitches.
    fortios_system_automation-stitch:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_system_automation-stitch_data(json):
...
def system_automation-stitch(data, fos):
    vdom = data['vdom']
    system_automation-stitch_data = data['system_automation-stitch']
    filtered_data = filter_system_automation - \
        stitch_data(system_automation-stitch_data)

    if system_automation-stitch_data['state'] == "present":
        return fos.set('system',
                       'automation-stitch',
                       data=filtered_data,
                       vdom=vdom)

    elif system_automation-stitch_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_automation-stitch']
