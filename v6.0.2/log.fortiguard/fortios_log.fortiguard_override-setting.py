...
DOCUMENTATION = '''
---
module: fortios_log.fortiguard_override-setting
short_description: Override global FortiCloud logging settings for this VDOM.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure log.fortiguard feature and override-setting category.
...
- hosts: localhost
  ...
  - name: Override global FortiCloud logging settings for this VDOM.
    fortios_log.fortiguard_override-setting:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_log.fortiguard_override-setting_data(json):
...
def log.fortiguard_override-setting(data, fos):
    vdom = data['vdom']
    log.fortiguard_override-setting_data = data['log.fortiguard_override-setting']
    filtered_data = filter_log.fortiguard_override - \
        setting_data(log.fortiguard_override-setting_data)

    if log.fortiguard_override-setting_data['state'] == "present":
        return fos.set('log.fortiguard',
                       'override-setting',
                       data=filtered_data,
                       vdom=vdom)

    elif log.fortiguard_override-setting_data['state'] == "absent":
...
def fortios_log.fortiguard(data, fos):
    ...
    methodlist = ['log.fortiguard_override-setting']
