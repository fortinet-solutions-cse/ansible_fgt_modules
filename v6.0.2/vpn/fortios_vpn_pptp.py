...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure vpn feature and pptp category.
...
def vpn_pptp(data, fos):
    ...
    if vpn_pptp_data['state'] == "present":
        return fos.set('vpn',
                       'pptp',
                       data=filtered_data,
                       vdom=vdom)

    elif vpn_pptp_data['state'] == "absent":
    ...
    fields = {
        ...
        "vpn_pptp": {
            ...
            "options": {
                ...
                "local-ip": {"required": False, "type": "ipv4-address"},
