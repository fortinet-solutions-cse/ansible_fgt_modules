...
DOCUMENTATION = '''
---
module: fortios_dlp_fp-sensitivity
...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure dlp feature and fp-sensitivity category.
...
def filter_dlp_fp-sensitivity_data(json):
    option_list = ['name']
    dictionary = {}
...
def dlp_fp-sensitivity(data, fos):
    vdom = data['vdom']
    dlp_fp-sensitivity_data = data['dlp_fp-sensitivity']
    filtered_data = filter_dlp_fp-sensitivity_data(dlp_fp-sensitivity_data)

    if dlp_fp-sensitivity_data['state'] == "present":
        return fos.set('dlp',
                       'fp-sensitivity',
                       data=filtered_data,
                       vdom=vdom)

    elif dlp_fp-sensitivity_data['state'] == "absent":
