...
def system_vdom_link(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(system_vdom_link_data)
    filtered_data = filter_system_vdom_link_data(flattened_data)
    if system_vdom_link_data['state'] == "present":
        return fos.set('system',
                       'vdom-link',
                       data=filtered_data,
                       vdom=vdom)

    elif system_vdom_link_data['state'] == "absent":
