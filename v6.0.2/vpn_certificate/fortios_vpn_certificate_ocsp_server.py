...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure vpn_certificate feature and ocsp_server category.
...
def vpn_certificate_ocsp_server(data, fos):
    ...
    filtered_data = filter_vpn_certificate_ocsp_server_data(vpn_certificate_ocsp_server_data)
...
def fortios_vpn_certificate(data, fos):
    ...
    methodlist = ['vpn_certificate_ocsp_server']
