...
DOCUMENTATION = '''
---
module: fortios_switch-controller_managed-switch
short_description: Configure FortiSwitch devices that are managed by this FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure switch-controller feature and managed-switch category.
...
- hosts: localhost
  ...
  - name: Configure FortiSwitch devices that are managed by this FortiGate.
    fortios_switch-controller_managed-switch:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_switch-controller_managed-switch_data(json):
...
def switch-controller_managed-switch(data, fos):
    vdom = data['vdom']
    switch-controller_managed-switch_data = data['switch-controller_managed-switch']
    filtered_data = filter_switch-controller_managed - \
        switch_data(switch-controller_managed-switch_data)

    if switch-controller_managed-switch_data['state'] == "present":
        return fos.set('switch-controller',
                       'managed-switch',
                       data=filtered_data,
                       vdom=vdom)

    elif switch-controller_managed-switch_data['state'] == "absent":
...
def fortios_switch-controller(data, fos):
    ...
    methodlist = ['switch-controller_managed-switch']
        ...
        "switch-controller_managed-switch": {
            ...
            "options": {
                ...
                "custom-command": {"required": False, "type": "list",
                                   "options": {
                                       "command-entry": {"required": False, "type": "str"},
                ...
                "ports": {"required": False, "type": "list",
                          "options": {
                              "allowed-vlans": {"required": False, "type": "list",
                                                "options": {
                                                    "vlan-name": {"required": False, "type": "str"}
                                                }},
                              ...
                              "export-tags": {"required": False, "type": "list",
                                              "options": {
                                                  "tag-name": {"required": False, "type": "str"}
                                              }},
                              ...
                              "members": {"required": False, "type": "list",
                                          "options": {
                                              "member-name": {"required": False, "type": "str"}
                                          }},
                              ...
                              "poe-status": {"required": False, "type": "str",
                                             "choices": ["enable", "disable"]},
                              "port-name": {"required": False, "type": "str"},
