...
DOCUMENTATION = '''
---
module: fortios_switch-controller_stp-settings
short_description: Configure FortiSwitch spanning tree protocol (STP).
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure switch-controller feature and stp-settings category.
...
- hosts: localhost
  ...
  - name: Configure FortiSwitch spanning tree protocol (STP).
    fortios_switch-controller_stp-settings:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_switch-controller_stp-settings_data(json):
...
def switch-controller_stp-settings(data, fos):
    vdom = data['vdom']
    switch-controller_stp-settings_data = data['switch-controller_stp-settings']
    filtered_data = filter_switch-controller_stp - \
        settings_data(switch-controller_stp-settings_data)

    if switch-controller_stp-settings_data['state'] == "present":
        return fos.set('switch-controller',
                       'stp-settings',
                       data=filtered_data,
                       vdom=vdom)

    elif switch-controller_stp-settings_data['state'] == "absent":
...
def fortios_switch-controller(data, fos):
    ...
    methodlist = ['switch-controller_stp-settings']
