...
description:
    - This module is able to configure a FortiGate or FortiOS (FOS) device by allowing the
      user to set and modify firewall feature and internet_service_custom_group category.
...
def firewall_internet_service_custom_group(data, fos):
    ...
    filtered_data = underscore_to_hyphen(filter_firewall_internet_service_custom_group_data(firewall_internet_service_custom_group_data))
...
def fortios_firewall(data, fos):
    ...
    if data['firewall_internet_service_custom_group']:
        resp = firewall_internet_service_custom_group(data, fos)
