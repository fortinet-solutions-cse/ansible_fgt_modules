...
DOCUMENTATION = '''
---
module: fortios_firewall_ldb-monitor
short_description: Configure server load balancing health monitors.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure firewall feature and ldb-monitor category.
...
def filter_firewall_ldb-monitor_data(json):
...
def firewall_ldb-monitor(data, fos):
    vdom = data['vdom']
    firewall_ldb-monitor_data = data['firewall_ldb-monitor']
    filtered_data = filter_firewall_ldb-monitor_data(firewall_ldb-monitor_data)

    if firewall_ldb-monitor_data['state'] == "present":
        return fos.set('firewall',
                       'ldb-monitor',
                       data=filtered_data,
                       vdom=vdom)

    elif firewall_ldb-monitor_data['state'] == "absent":
...
def fortios_firewall(data, fos):
    ...
    methodlist = ['firewall_ldb-monitor']
