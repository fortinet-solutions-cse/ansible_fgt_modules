...
DOCUMENTATION = '''
---
module: fortios_webfilter_ips-urlfilter-setting6
short_description: Configure IPS URL filter settings for IPv6.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure webfilter feature and ips-urlfilter-setting6 category.
...
- hosts: localhost
  ...
  - name: Configure IPS URL filter settings for IPv6.
    fortios_webfilter_ips-urlfilter-setting6:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_webfilter_ips-urlfilter-setting6_data(json):
...
def webfilter_ips-urlfilter-setting6(data, fos):
    vdom = data['vdom']
    webfilter_ips-urlfilter-setting6_data = data['webfilter_ips-urlfilter-setting6']
    filtered_data = filter_webfilter_ips-urlfilter - \
        setting6_data(webfilter_ips-urlfilter-setting6_data)

    if webfilter_ips-urlfilter-setting6_data['state'] == "present":
        return fos.set('webfilter',
                       'ips-urlfilter-setting6',
                       data=filtered_data,
                       vdom=vdom)

    elif webfilter_ips-urlfilter-setting6_data['state'] == "absent":
...
def fortios_webfilter(data, fos):
    ...
    methodlist = ['webfilter_ips-urlfilter-setting6']
