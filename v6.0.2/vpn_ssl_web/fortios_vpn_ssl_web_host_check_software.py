...
def vpn_ssl_web_host_check_software(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(vpn_ssl_web_host_check_software_data)
    filtered_data = filter_vpn_ssl_web_host_check_software_data(flattened_data)
