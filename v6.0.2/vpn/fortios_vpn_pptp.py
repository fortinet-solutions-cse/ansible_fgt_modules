...
description:
    - This module is able to configure a FortiGate or FortiOS by allowing the
      user to set and modify vpn feature and pptp category.
...
def filter_vpn_pptp_data(json):
    option_list = ['eip', 'ip-mode', 'local-ip',
                   'sip', 'status', 'usrgrp']
    dictionary = {}
...
def vpn_pptp(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(vpn_pptp_data)
    filtered_data = filter_vpn_pptp_data(flattened_data)
    return fos.set('vpn',
                   'pptp',
                   data=filtered_data,
                   vdom=vdom)
    ...
    fields = {
        ...
        "vpn_pptp": {
            ...
            "options": {
                ...
                "local-ip": {"required": False, "type": "str"},
