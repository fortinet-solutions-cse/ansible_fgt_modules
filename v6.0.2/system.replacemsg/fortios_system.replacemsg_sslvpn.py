...
DOCUMENTATION = '''
---
module: fortios_system.replacemsg_sslvpn
short_description: Replacement messages in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system.replacemsg feature and sslvpn category.
...
def filter_system.replacemsg_sslvpn_data(json):
...
def system.replacemsg_sslvpn(data, fos):
    vdom = data['vdom']
    system.replacemsg_sslvpn_data = data['system.replacemsg_sslvpn']
    filtered_data = filter_system.replacemsg_sslvpn_data(system.replacemsg_sslvpn_data)
    if system.replacemsg_sslvpn_data['state'] == "present":
        return fos.set('system.replacemsg',
                       'sslvpn',
                       data=filtered_data,
                       vdom=vdom)

    elif system.replacemsg_sslvpn_data['state'] == "absent":
...
def fortios_system.replacemsg(data, fos):
    ...
    methodlist = ['system.replacemsg_sslvpn']
