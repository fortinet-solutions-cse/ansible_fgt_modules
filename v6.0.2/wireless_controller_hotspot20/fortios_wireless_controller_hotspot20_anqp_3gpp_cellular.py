...
short_description: Configure 3GPP public land mobile network (PLMN) in Fortinet's FortiOS and FortiGate.
description:
...
def filter_wireless_controller_hotspot20_anqp_3gpp_cellular_data(json):
...
def wireless_controller_hotspot20_anqp_3gpp_cellular(data, fos):
    vdom = data['vdom']
    wireless_controller_hotspot20_anqp_3gpp_cellular_data = data['wireless_controller_hotspot20_anqp_3gpp_cellular']
    flattened_data = flatten_multilists_attributes(wireless_controller_hotspot20_anqp_3gpp_cellular_data)
    filtered_data = filter_wireless_controller_hotspot20_anqp_3gpp_cellular_data(flattened_data)
    if wireless_controller_hotspot20_anqp_3gpp_cellular_data['state'] == "present":
        return fos.set('wireless-controller.hotspot20',
                       'anqp-3gpp-cellular',
                       data=filtered_data,
                       vdom=vdom)

    elif wireless_controller_hotspot20_anqp_3gpp_cellular_data['state'] == "absent":
