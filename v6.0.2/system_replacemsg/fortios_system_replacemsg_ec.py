...
def system_replacemsg_ec(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(system_replacemsg_ec_data)
    filtered_data = filter_system_replacemsg_ec_data(flattened_data)
    if system_replacemsg_ec_data['state'] == "present":
        return fos.set('system.replacemsg',
                       'ec',
                       data=filtered_data,
                       vdom=vdom)

    elif system_replacemsg_ec_data['state'] == "absent":
...
def fortios_system_replacemsg(data, fos):
    ...
    methodlist = ['system_replacemsg_ec']
