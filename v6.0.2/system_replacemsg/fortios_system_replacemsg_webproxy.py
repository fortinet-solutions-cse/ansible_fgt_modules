...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system_replacemsg feature and webproxy category.
...
def system_replacemsg_webproxy(data, fos):
    ...
    filtered_data = filter_system_replacemsg_webproxy_data(system_replacemsg_webproxy_data)
...
def fortios_system_replacemsg(data, fos):
    ...
    methodlist = ['system_replacemsg_webproxy']
