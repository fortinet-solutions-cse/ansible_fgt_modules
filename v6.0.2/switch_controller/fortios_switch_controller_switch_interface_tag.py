...
def filter_switch_controller_switch_interface_tag_data(json):
    option_list = ['name']
    dictionary = {}
...
def switch_controller_switch_interface_tag(data, fos):
    vdom = data['vdom']
    switch_controller_switch_interface_tag_data = data['switch_controller_switch_interface_tag']
    flattened_data = flatten_multilists_attributes(switch_controller_switch_interface_tag_data)
    filtered_data = filter_switch_controller_switch_interface_tag_data(flattened_data)
    if switch_controller_switch_interface_tag_data['state'] == "present":
        return fos.set('switch-controller',
                       'switch-interface-tag',
                       data=filtered_data,
                       vdom=vdom)

    elif switch_controller_switch_interface_tag_data['state'] == "absent":
