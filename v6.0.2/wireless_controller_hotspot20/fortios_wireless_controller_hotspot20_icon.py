...
def wireless_controller_hotspot20_icon(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(wireless_controller_hotspot20_icon_data)
    filtered_data = filter_wireless_controller_hotspot20_icon_data(flattened_data)
