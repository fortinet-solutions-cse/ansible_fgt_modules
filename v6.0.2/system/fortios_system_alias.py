...
def system_alias(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(system_alias_data)
    filtered_data = filter_system_alias_data(flattened_data)
    if system_alias_data['state'] == "present":
        return fos.set('system',
                       'alias',
                       data=filtered_data,
                       vdom=vdom)

    elif system_alias_data['state'] == "absent":
