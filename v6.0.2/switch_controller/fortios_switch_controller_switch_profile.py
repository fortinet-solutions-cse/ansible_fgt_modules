...
def switch_controller_switch_profile(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(switch_controller_switch_profile_data)
    filtered_data = filter_switch_controller_switch_profile_data(flattened_data)
    if switch_controller_switch_profile_data['state'] == "present":
        return fos.set('switch-controller',
                       'switch-profile',
                       data=filtered_data,
                       vdom=vdom)

    elif switch_controller_switch_profile_data['state'] == "absent":
...
def fortios_switch_controller(data, fos):
    ...
    methodlist = ['switch_controller_switch_profile']
