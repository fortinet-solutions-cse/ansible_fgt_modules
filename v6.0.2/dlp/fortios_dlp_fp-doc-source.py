...
DOCUMENTATION = '''
---
module: fortios_dlp_fp-doc-source
...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure dlp feature and fp-doc-source category.
...
def filter_dlp_fp-doc-source_data(json):
...
def dlp_fp-doc-source(data, fos):
    vdom = data['vdom']
    dlp_fp-doc-source_data = data['dlp_fp-doc-source']
    filtered_data = filter_dlp_fp-doc-source_data(dlp_fp-doc-source_data)

    if dlp_fp-doc-source_data['state'] == "present":
        return fos.set('dlp',
                       'fp-doc-source',
                       data=filtered_data,
                       vdom=vdom)

    elif dlp_fp-doc-source_data['state'] == "absent":
