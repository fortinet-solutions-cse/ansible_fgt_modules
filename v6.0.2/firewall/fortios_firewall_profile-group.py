...
DOCUMENTATION = '''
---
module: fortios_firewall_profile-group
short_description: Configure profile groups.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure firewall feature and profile-group category.
...
- hosts: localhost
  ...
  - name: Configure profile groups.
    fortios_firewall_profile-group:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_firewall_profile-group_data(json):
...
def firewall_profile-group(data, fos):
    vdom = data['vdom']
    firewall_profile-group_data = data['firewall_profile-group']
    filtered_data = filter_firewall_profile - \
        group_data(firewall_profile-group_data)

    if firewall_profile-group_data['state'] == "present":
        return fos.set('firewall',
                       'profile-group',
                       data=filtered_data,
                       vdom=vdom)

    elif firewall_profile-group_data['state'] == "absent":
...
def fortios_firewall(data, fos):
    ...
    methodlist = ['firewall_profile-group']
