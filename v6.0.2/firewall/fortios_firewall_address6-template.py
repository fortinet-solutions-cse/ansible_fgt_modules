...
DOCUMENTATION = '''
---
module: fortios_firewall_address6-template
short_description: Configure IPv6 address templates.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure firewall feature and address6-template category.
...
- hosts: localhost
  ...
  - name: Configure IPv6 address templates.
    fortios_firewall_address6-template:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_firewall_address6-template_data(json):
...
def firewall_address6-template(data, fos):
    vdom = data['vdom']
    firewall_address6-template_data = data['firewall_address6-template']
    filtered_data = filter_firewall_address6 - \
        template_data(firewall_address6-template_data)

    if firewall_address6-template_data['state'] == "present":
        return fos.set('firewall',
                       'address6-template',
                       data=filtered_data,
                       vdom=vdom)

    elif firewall_address6-template_data['state'] == "absent":
...
def fortios_firewall(data, fos):
    ...
    methodlist = ['firewall_address6-template']
