...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure wireless_controller_hotspot20 feature and icon category.
...
def filter_wireless_controller_hotspot20_icon_data(json):
...
def wireless_controller_hotspot20_icon(data, fos):
    vdom = data['vdom']
    wireless_controller_hotspot20_icon_data = data['wireless_controller_hotspot20_icon']
    filtered_data = filter_wireless_controller_hotspot20_icon_data(wireless_controller_hotspot20_icon_data)
    if wireless_controller_hotspot20_icon_data['state'] == "present":
        return fos.set('wireless-controller.hotspot20',
                       'icon',
                       data=filtered_data,
                       vdom=vdom)

    elif wireless_controller_hotspot20_icon_data['state'] == "absent":
