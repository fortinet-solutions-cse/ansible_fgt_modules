...
DOCUMENTATION = '''
---
module: fortios_system_auto-install
short_description: Configure USB auto installation.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and auto-install category.
...
def filter_system_auto-install_data(json):
...
def system_auto-install(data, fos):
    vdom = data['vdom']
    system_auto-install_data = data['system_auto-install']
    filtered_data = filter_system_auto-install_data(system_auto-install_data)

    if system_auto-install_data['state'] == "present":
        return fos.set('system',
                       'auto-install',
                       data=filtered_data,
                       vdom=vdom)

    elif system_auto-install_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_auto-install']
