...
DOCUMENTATION = '''
---
module: fortios_web-proxy_url-match
short_description: Exempt URLs from web proxy forwarding and caching.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure web-proxy feature and url-match category.
...
def filter_web-proxy_url-match_data(json):
...
def web-proxy_url-match(data, fos):
    vdom = data['vdom']
    web-proxy_url-match_data = data['web-proxy_url-match']
    filtered_data = filter_web-proxy_url-match_data(web-proxy_url-match_data)

    if web-proxy_url-match_data['state'] == "present":
        return fos.set('web-proxy',
                       'url-match',
                       data=filtered_data,
                       vdom=vdom)

    elif web-proxy_url-match_data['state'] == "absent":
...
def fortios_web-proxy(data, fos):
    ...
    methodlist = ['web-proxy_url-match']
