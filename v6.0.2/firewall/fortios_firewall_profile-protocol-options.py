...
DOCUMENTATION = '''
---
module: fortios_firewall_profile-protocol-options
short_description: Configure protocol options.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure firewall feature and profile-protocol-options category.
...
- hosts: localhost
  ...
  - name: Configure protocol options.
    fortios_firewall_profile-protocol-options:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_firewall_profile-protocol-options_data(json):
...
def firewall_profile-protocol-options(data, fos):
    vdom = data['vdom']
    firewall_profile-protocol-options_data = data['firewall_profile-protocol-options']
    filtered_data = filter_firewall_profile-protocol - \
        options_data(firewall_profile-protocol-options_data)

    if firewall_profile-protocol-options_data['state'] == "present":
        return fos.set('firewall',
                       'profile-protocol-options',
                       data=filtered_data,
                       vdom=vdom)

    elif firewall_profile-protocol-options_data['state'] == "absent":
...
def fortios_firewall(data, fos):
    ...
    methodlist = ['firewall_profile-protocol-options']
