...
def system_replacemsg_utm(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(system_replacemsg_utm_data)
    filtered_data = filter_system_replacemsg_utm_data(flattened_data)
    if system_replacemsg_utm_data['state'] == "present":
        return fos.set('system.replacemsg',
                       'utm',
                       data=filtered_data,
                       vdom=vdom)

    elif system_replacemsg_utm_data['state'] == "absent":
...
def fortios_system_replacemsg(data, fos):
    ...
    methodlist = ['system_replacemsg_utm']
