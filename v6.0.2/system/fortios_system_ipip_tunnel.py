...
def system_ipip_tunnel(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(system_ipip_tunnel_data)
    filtered_data = filter_system_ipip_tunnel_data(flattened_data)
...
def fortios_system(data, fos):
    ...
    if data['system_ipip_tunnel']:
        resp = system_ipip_tunnel(data, fos)
