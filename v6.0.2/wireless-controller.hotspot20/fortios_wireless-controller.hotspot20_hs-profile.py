...
DOCUMENTATION = '''
---
module: fortios_wireless-controller.hotspot20_hs-profile
short_description: Configure hotspot profile.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure wireless-controller.hotspot20 feature and hs-profile category.
...
- hosts: localhost
  ...
  - name: Configure hotspot profile.
    fortios_wireless-controller.hotspot20_hs-profile:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_wireless-controller.hotspot20_hs-profile_data(json):
...
def wireless-controller.hotspot20_hs-profile(data, fos):
    vdom = data['vdom']
    wireless-controller.hotspot20_hs-profile_data = data['wireless-controller.hotspot20_hs-profile']
    filtered_data = filter_wireless-controller.hotspot20_hs - \
        profile_data(wireless-controller.hotspot20_hs-profile_data)

    if wireless-controller.hotspot20_hs-profile_data['state'] == "present":
        return fos.set('wireless-controller.hotspot20',
                       'hs-profile',
                       data=filtered_data,
                       vdom=vdom)

    elif wireless-controller.hotspot20_hs-profile_data['state'] == "absent":
...
def fortios_wireless-controller.hotspot20(data, fos):
    ...
    methodlist = ['wireless-controller.hotspot20_hs-profile']
    ...
    fields = {
        ...
        "wireless-controller.hotspot20_hs-profile": {
            ...
            "options": {
                ...
                "hessid": {"required": False, "type": "mac-address"},
