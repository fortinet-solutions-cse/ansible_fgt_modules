...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system_replacemsg feature and alertmail category.
...
def system_replacemsg_alertmail(data, fos):
    ...
    filtered_data = filter_system_replacemsg_alertmail_data(system_replacemsg_alertmail_data)
    if system_replacemsg_alertmail_data['state'] == "present":
        return fos.set('system.replacemsg',
                       'alertmail',
                       data=filtered_data,
                       vdom=vdom)

    elif system_replacemsg_alertmail_data['state'] == "absent":
...
def fortios_system_replacemsg(data, fos):
    ...
    methodlist = ['system_replacemsg_alertmail']
