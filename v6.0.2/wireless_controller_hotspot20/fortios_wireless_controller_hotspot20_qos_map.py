...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure wireless_controller_hotspot20 feature and qos_map category.
...
def wireless_controller_hotspot20_qos_map(data, fos):
    ...
    filtered_data = filter_wireless_controller_hotspot20_qos_map_data(wireless_controller_hotspot20_qos_map_data)
...
def fortios_wireless_controller_hotspot20(data, fos):
    ...
    methodlist = ['wireless_controller_hotspot20_qos_map']
