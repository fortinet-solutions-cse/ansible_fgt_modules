...
def filter_wireless_controller.hotspot20_icon_data(json):
...
def wireless_controller.hotspot20_icon(data, fos):
    ...
    elif wireless_controller.hotspot20_icon_data['state'] == "absent":
...
def fortios_wireless_controller.hotspot20(data, fos):
    ...
    methodlist = ['wireless_controller.hotspot20_icon']
