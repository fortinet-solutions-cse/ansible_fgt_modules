...
DOCUMENTATION = '''
---
module: fortios_log.fortianalyzer_filter
...
def filter_log.fortianalyzer_filter_data(json):
...
def log.fortianalyzer_filter(data, fos):
    vdom = data['vdom']
    log.fortianalyzer_filter_data = data['log.fortianalyzer_filter']
    filtered_data = filter_log.fortianalyzer_filter_data(log.fortianalyzer_filter_data)
