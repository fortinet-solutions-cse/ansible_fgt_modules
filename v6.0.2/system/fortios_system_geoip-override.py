...
DOCUMENTATION = '''
---
module: fortios_system_geoip-override
...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and geoip-override category.
...
def filter_system_geoip-override_data(json):
...
def system_geoip-override(data, fos):
    vdom = data['vdom']
    system_geoip-override_data = data['system_geoip-override']
    filtered_data = filter_system_geoip - \
        override_data(system_geoip-override_data)

    if system_geoip-override_data['state'] == "present":
        return fos.set('system',
                       'geoip-override',
                       data=filtered_data,
                       vdom=vdom)

    elif system_geoip-override_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_geoip-override']
