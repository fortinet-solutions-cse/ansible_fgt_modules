...
def system_ha_monitor(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(system_ha_monitor_data)
    filtered_data = filter_system_ha_monitor_data(flattened_data)
