...
DOCUMENTATION = '''
---
module: fortios_wireless-controller_utm-profile
short_description: Configure UTM (Unified Threat Management) profile.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure wireless-controller feature and utm-profile category.
...
- hosts: localhost
  ...
  - name: Configure UTM (Unified Threat Management) profile.
    fortios_wireless-controller_utm-profile:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_wireless-controller_utm-profile_data(json):
...
def wireless-controller_utm-profile(data, fos):
    vdom = data['vdom']
    wireless-controller_utm-profile_data = data['wireless-controller_utm-profile']
    filtered_data = filter_wireless-controller_utm - \
        profile_data(wireless-controller_utm-profile_data)

    if wireless-controller_utm-profile_data['state'] == "present":
        return fos.set('wireless-controller',
                       'utm-profile',
                       data=filtered_data,
                       vdom=vdom)

    elif wireless-controller_utm-profile_data['state'] == "absent":
...
def fortios_wireless-controller(data, fos):
    ...
    methodlist = ['wireless-controller_utm-profile']
