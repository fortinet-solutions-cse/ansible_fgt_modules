...
DOCUMENTATION = '''
---
module: fortios_system_vdom-property
short_description: Configure VDOM property.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and vdom-property category.
...
def filter_system_vdom-property_data(json):
...
def system_vdom-property(data, fos):
    vdom = data['vdom']
    system_vdom-property_data = data['system_vdom-property']
    filtered_data = filter_system_vdom-property_data(system_vdom-property_data)

    if system_vdom-property_data['state'] == "present":
        return fos.set('system',
                       'vdom-property',
                       data=filtered_data,
                       vdom=vdom)

    elif system_vdom-property_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_vdom-property']
