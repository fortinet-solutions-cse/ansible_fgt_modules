...
DOCUMENTATION = '''
---
module: fortios_wireless-controller.hotspot20_h2qp-conn-capability
short_description: Configure connection capability.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure wireless-controller.hotspot20 feature and h2qp-conn-capability category.
...
- hosts: localhost
  ...
  - name: Configure connection capability.
    fortios_wireless-controller.hotspot20_h2qp-conn-capability:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_wireless-controller.hotspot20_h2qp-conn-capability_data(json):
...
def wireless-controller.hotspot20_h2qp-conn-capability(data, fos):
    vdom = data['vdom']
    wireless-controller.hotspot20_h2qp-conn-capability_data = data['wireless-controller.hotspot20_h2qp-conn-capability']
    filtered_data = filter_wireless-controller.hotspot20_h2qp-conn - \
        capability_data(
            wireless -
            controller.hotspot20_h2qp -
            conn -
            capability_data)

    if wireless-controller.hotspot20_h2qp-conn - \
            capability_data['state'] == "present":
        return fos.set('wireless-controller.hotspot20',
                       'h2qp-conn-capability',
                       data=filtered_data,
                       vdom=vdom)

    elif wireless-controller.hotspot20_h2qp-conn-capability_data['state'] == "absent":
...
def fortios_wireless-controller.hotspot20(data, fos):
    ...
    methodlist = ['wireless-controller.hotspot20_h2qp-conn-capability']
