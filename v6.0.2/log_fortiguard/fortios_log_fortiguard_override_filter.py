...
def log_fortiguard_override_filter(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(log_fortiguard_override_filter_data)
    filtered_data = filter_log_fortiguard_override_filter_data(flattened_data)
