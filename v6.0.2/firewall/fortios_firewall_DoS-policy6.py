...
DOCUMENTATION = '''
---
module: fortios_firewall_DoS-policy6
short_description: Configure IPv6 DoS policies.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure firewall feature and DoS-policy6 category.
...
def filter_firewall_DoS-policy6_data(json):
...
def firewall_DoS-policy6(data, fos):
    vdom = data['vdom']
    firewall_DoS-policy6_data = data['firewall_DoS-policy6']
    filtered_data = filter_firewall_DoS-policy6_data(firewall_DoS-policy6_data)

    if firewall_DoS-policy6_data['state'] == "present":
        return fos.set('firewall',
                       'DoS-policy6',
                       data=filtered_data,
                       vdom=vdom)

    elif firewall_DoS-policy6_data['state'] == "absent":
...
def fortios_firewall(data, fos):
    ...
    methodlist = ['firewall_DoS-policy6']
