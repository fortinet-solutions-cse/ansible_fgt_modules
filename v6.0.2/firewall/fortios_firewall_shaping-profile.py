...
DOCUMENTATION = '''
---
module: fortios_firewall_shaping-profile
short_description: Configure shaping profiles.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure firewall feature and shaping-profile category.
...
- hosts: localhost
  ...
  - name: Configure shaping profiles.
    fortios_firewall_shaping-profile:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_firewall_shaping-profile_data(json):
...
def firewall_shaping-profile(data, fos):
    vdom = data['vdom']
    firewall_shaping-profile_data = data['firewall_shaping-profile']
    filtered_data = filter_firewall_shaping - \
        profile_data(firewall_shaping-profile_data)

    if firewall_shaping-profile_data['state'] == "present":
        return fos.set('firewall',
                       'shaping-profile',
                       data=filtered_data,
                       vdom=vdom)

    elif firewall_shaping-profile_data['state'] == "absent":
...
def fortios_firewall(data, fos):
    ...
    methodlist = ['firewall_shaping-profile']
