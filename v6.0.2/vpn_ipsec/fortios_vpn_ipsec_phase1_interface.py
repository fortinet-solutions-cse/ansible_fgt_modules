...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure vpn_ipsec feature and phase1_interface category.
...
def vpn_ipsec_phase1_interface(data, fos):
    ...
    filtered_data = filter_vpn_ipsec_phase1_interface_data(vpn_ipsec_phase1_interface_data)
...
def fortios_vpn_ipsec(data, fos):
    ...
    methodlist = ['vpn_ipsec_phase1_interface']
