...
def vpn_ssl_web_user_group_bookmark(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(vpn_ssl_web_user_group_bookmark_data)
    filtered_data = filter_vpn_ssl_web_user_group_bookmark_data(flattened_data)
...
def fortios_vpn_ssl_web(data, fos):
    ...
    methodlist = ['vpn_ssl_web_user_group_bookmark']
