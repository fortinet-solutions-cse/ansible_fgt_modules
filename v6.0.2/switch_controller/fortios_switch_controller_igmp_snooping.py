...
def filter_switch_controller_igmp_snooping_data(json):
...
def switch_controller_igmp_snooping(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(switch_controller_igmp_snooping_data)
    filtered_data = filter_switch_controller_igmp_snooping_data(flattened_data)
...
def fortios_switch_controller(data, fos):
    ...
    methodlist = ['switch_controller_igmp_snooping']
