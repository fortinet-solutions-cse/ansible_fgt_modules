...
DOCUMENTATION = '''
---
module: fortios_wireless-controller_wids-profile
short_description: Configure wireless intrusion detection system (WIDS) profiles.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure wireless-controller feature and wids-profile category.
...
- hosts: localhost
  ...
  - name: Configure wireless intrusion detection system (WIDS) profiles.
    fortios_wireless-controller_wids-profile:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_wireless-controller_wids-profile_data(json):
...
def wireless-controller_wids-profile(data, fos):
    vdom = data['vdom']
    wireless-controller_wids-profile_data = data['wireless-controller_wids-profile']
    filtered_data = filter_wireless-controller_wids - \
        profile_data(wireless-controller_wids-profile_data)

    if wireless-controller_wids-profile_data['state'] == "present":
        return fos.set('wireless-controller',
                       'wids-profile',
                       data=filtered_data,
                       vdom=vdom)

    elif wireless-controller_wids-profile_data['state'] == "absent":
...
def fortios_wireless-controller(data, fos):
    ...
    methodlist = ['wireless-controller_wids-profile']
