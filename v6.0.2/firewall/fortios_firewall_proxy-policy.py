...
DOCUMENTATION = '''
---
module: fortios_firewall_proxy-policy
short_description: Configure proxy policies.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure firewall feature and proxy-policy category.
...
def filter_firewall_proxy-policy_data(json):
...
def firewall_proxy-policy(data, fos):
    vdom = data['vdom']
    firewall_proxy-policy_data = data['firewall_proxy-policy']
    filtered_data = filter_firewall_proxy - \
        policy_data(firewall_proxy-policy_data)

    if firewall_proxy-policy_data['state'] == "present":
        return fos.set('firewall',
                       'proxy-policy',
                       data=filtered_data,
                       vdom=vdom)

    elif firewall_proxy-policy_data['state'] == "absent":
...
def fortios_firewall(data, fos):
    ...
    methodlist = ['firewall_proxy-policy']
