...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system_replacemsg feature and device_detection_portal category.
...
def system_replacemsg_device_detection_portal(data, fos):
    ...
    filtered_data = filter_system_replacemsg_device_detection_portal_data(system_replacemsg_device_detection_portal_data)
...
def fortios_system_replacemsg(data, fos):
    ...
    methodlist = ['system_replacemsg_device_detection_portal']
