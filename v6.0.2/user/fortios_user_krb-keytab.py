...
DOCUMENTATION = '''
---
module: fortios_user_krb-keytab
short_description: Configure Kerberos keytab entries.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure user feature and krb-keytab category.
...
def filter_user_krb-keytab_data(json):
...
def user_krb-keytab(data, fos):
    vdom = data['vdom']
    user_krb-keytab_data = data['user_krb-keytab']
    filtered_data = filter_user_krb-keytab_data(user_krb-keytab_data)

    if user_krb-keytab_data['state'] == "present":
        return fos.set('user',
                       'krb-keytab',
                       data=filtered_data,
                       vdom=vdom)

    elif user_krb-keytab_data['state'] == "absent":
