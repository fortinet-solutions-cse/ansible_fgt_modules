...
def firewall_internet_service_group(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(firewall_internet_service_group_data)
    filtered_data = filter_firewall_internet_service_group_data(flattened_data)
