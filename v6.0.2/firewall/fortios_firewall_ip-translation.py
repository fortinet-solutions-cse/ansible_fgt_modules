...
DOCUMENTATION = '''
---
module: fortios_firewall_ip-translation
short_description: Configure firewall IP-translation.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure firewall feature and ip-translation category.
...
- hosts: localhost
  ...
  - name: Configure firewall IP-translation.
    fortios_firewall_ip-translation:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_firewall_ip-translation_data(json):
...
def firewall_ip-translation(data, fos):
    vdom = data['vdom']
    firewall_ip-translation_data = data['firewall_ip-translation']
    filtered_data = filter_firewall_ip - \
        translation_data(firewall_ip-translation_data)

    if firewall_ip-translation_data['state'] == "present":
        return fos.set('firewall',
                       'ip-translation',
                       data=filtered_data,
                       vdom=vdom)

    elif firewall_ip-translation_data['state'] == "absent":
...
def fortios_firewall(data, fos):
    ...
    methodlist = ['firewall_ip-translation']
    ...
    fields = {
        ...
        "firewall_ip-translation": {
            ...
            "options": {
                ...
                "map-startip": {"required": False, "type": "ipv4-address-any"},
                "startip": {"required": False, "type": "ipv4-address-any"},
                "transid": {"required": False, "type": "int"},
