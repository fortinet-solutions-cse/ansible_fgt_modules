...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure wireless_controller_hotspot20 feature and h2qp_operator_name category.
...
def wireless_controller_hotspot20_h2qp_operator_name(data, fos):
    ...
    filtered_data = filter_wireless_controller_hotspot20_h2qp_operator_name_data(wireless_controller_hotspot20_h2qp_operator_name_data)
    if wireless_controller_hotspot20_h2qp_operator_name_data['state'] == "present":
        return fos.set('wireless-controller.hotspot20',
                       'h2qp-operator-name',
                       data=filtered_data,
                       vdom=vdom)

    elif wireless_controller_hotspot20_h2qp_operator_name_data['state'] == "absent":
...
def fortios_wireless_controller_hotspot20(data, fos):
    ...
    methodlist = ['wireless_controller_hotspot20_h2qp_operator_name']
