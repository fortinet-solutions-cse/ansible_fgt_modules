...
DOCUMENTATION = '''
---
module: fortios_firewall_central-snat-map
short_description: Configure central SNAT policies.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure firewall feature and central-snat-map category.
...
- hosts: localhost
  ...
  - name: Configure central SNAT policies.
    fortios_firewall_central-snat-map:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_firewall_central-snat-map_data(json):
...
def firewall_central-snat-map(data, fos):
    vdom = data['vdom']
    firewall_central-snat-map_data = data['firewall_central-snat-map']
    filtered_data = filter_firewall_central-snat - \
        map_data(firewall_central-snat-map_data)

    if firewall_central-snat-map_data['state'] == "present":
        return fos.set('firewall',
                       'central-snat-map',
                       data=filtered_data,
                       vdom=vdom)

    elif firewall_central-snat-map_data['state'] == "absent":
...
def fortios_firewall(data, fos):
    ...
    methodlist = ['firewall_central-snat-map']
