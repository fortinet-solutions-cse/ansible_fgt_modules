...
DOCUMENTATION = '''
---
module: fortios_switch-controller_storm-control
short_description: Configure FortiSwitch storm control.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure switch-controller feature and storm-control category.
...
- hosts: localhost
  ...
  - name: Configure FortiSwitch storm control.
    fortios_switch-controller_storm-control:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_switch-controller_storm-control_data(json):
...
def switch-controller_storm-control(data, fos):
    vdom = data['vdom']
    switch-controller_storm-control_data = data['switch-controller_storm-control']
    filtered_data = filter_switch-controller_storm - \
        control_data(switch-controller_storm-control_data)

    if switch-controller_storm-control_data['state'] == "present":
        return fos.set('switch-controller',
                       'storm-control',
                       data=filtered_data,
                       vdom=vdom)

    elif switch-controller_storm-control_data['state'] == "absent":
...
def fortios_switch-controller(data, fos):
    ...
    methodlist = ['switch-controller_storm-control']
