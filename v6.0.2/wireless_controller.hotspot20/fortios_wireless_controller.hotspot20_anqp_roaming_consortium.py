...
def wireless_controller.hotspot20_anqp_roaming_consortium(data, fos):
    vdom = data['vdom']
    wireless_controller.hotspot20_anqp_roaming_consortium_data = data['wireless_controller.hotspot20_anqp_roaming_consortium']
    filtered_data = filter_wireless_controller.hotspot20_anqp_roaming_consortium_data(wireless_controller.hotspot20_anqp_roaming_consortium_data)
