...
def spamfilter_options(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(spamfilter_options_data)
    filtered_data = filter_spamfilter_options_data(flattened_data)
