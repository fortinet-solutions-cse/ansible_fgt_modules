...
DOCUMENTATION = '''
---
module: fortios_system_mobile-tunnel
...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and mobile-tunnel category.
...
def filter_system_mobile-tunnel_data(json):
...
def system_mobile-tunnel(data, fos):
    vdom = data['vdom']
    system_mobile-tunnel_data = data['system_mobile-tunnel']
    filtered_data = filter_system_mobile-tunnel_data(system_mobile-tunnel_data)

    if system_mobile-tunnel_data['state'] == "present":
        return fos.set('system',
                       'mobile-tunnel',
                       data=filtered_data,
                       vdom=vdom)

    elif system_mobile-tunnel_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_mobile-tunnel']
        ...
        "system_mobile-tunnel": {
            ...
            "options": {
                ...
                "hash-algorithm": {"required": False, "type": "str",
                                   "choices": ["hmac-md5"]},
                "home-address": {"required": False, "type": "ipv4-address"},
                "home-agent": {"required": False, "type": "ipv4-address"},
