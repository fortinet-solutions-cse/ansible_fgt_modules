...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure vpn_ipsec feature and phase2_interface category.
...
def vpn_ipsec_phase2_interface(data, fos):
    ...
    filtered_data = filter_vpn_ipsec_phase2_interface_data(vpn_ipsec_phase2_interface_data)
