...
DOCUMENTATION = '''
---
module: fortios_vpn.ssl.web_host-check-software
short_description: SSL-VPN host check software.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure vpn.ssl.web feature and host-check-software category.
...
- hosts: localhost
  ...
  - name: SSL-VPN host check software.
    fortios_vpn.ssl.web_host-check-software:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_vpn.ssl.web_host-check-software_data(json):
...
def vpn.ssl.web_host-check-software(data, fos):
    vdom = data['vdom']
    vpn.ssl.web_host-check-software_data = data['vpn.ssl.web_host-check-software']
    filtered_data = filter_vpn.ssl.web_host-check - \
        software_data(vpn.ssl.web_host-check-software_data)

    if vpn.ssl.web_host-check-software_data['state'] == "present":
        return fos.set('vpn.ssl.web',
                       'host-check-software',
                       data=filtered_data,
                       vdom=vdom)

    elif vpn.ssl.web_host-check-software_data['state'] == "absent":
...
def fortios_vpn.ssl.web(data, fos):
    ...
    methodlist = ['vpn.ssl.web_host-check-software']
