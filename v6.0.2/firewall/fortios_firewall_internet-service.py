...
DOCUMENTATION = '''
---
module: fortios_firewall_internet-service
short_description: Show Internet Service application.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure firewall feature and internet-service category.
...
- hosts: localhost
  ...
  - name: Show Internet Service application.
    fortios_firewall_internet-service:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_firewall_internet-service_data(json):
...
def firewall_internet-service(data, fos):
    vdom = data['vdom']
    firewall_internet-service_data = data['firewall_internet-service']
    filtered_data = filter_firewall_internet - \
        service_data(firewall_internet-service_data)

    if firewall_internet-service_data['state'] == "present":
        return fos.set('firewall',
                       'internet-service',
                       data=filtered_data,
                       vdom=vdom)

    elif firewall_internet-service_data['state'] == "absent":
...
def fortios_firewall(data, fos):
    ...
    methodlist = ['firewall_internet-service']
