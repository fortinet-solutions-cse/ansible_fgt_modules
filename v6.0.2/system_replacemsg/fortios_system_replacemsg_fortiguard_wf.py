...
def system_replacemsg_fortiguard_wf(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(system_replacemsg_fortiguard_wf_data)
    filtered_data = filter_system_replacemsg_fortiguard_wf_data(flattened_data)
