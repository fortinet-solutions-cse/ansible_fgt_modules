...
DOCUMENTATION = '''
---
module: fortios_wireless-controller_ble-profile
short_description: Configure Bluetooth Low Energy profile.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure wireless-controller feature and ble-profile category.
...
- hosts: localhost
  ...
  - name: Configure Bluetooth Low Energy profile.
    fortios_wireless-controller_ble-profile:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_wireless-controller_ble-profile_data(json):
...
def wireless-controller_ble-profile(data, fos):
    vdom = data['vdom']
    wireless-controller_ble-profile_data = data['wireless-controller_ble-profile']
    filtered_data = filter_wireless-controller_ble - \
        profile_data(wireless-controller_ble-profile_data)

    if wireless-controller_ble-profile_data['state'] == "present":
        return fos.set('wireless-controller',
                       'ble-profile',
                       data=filtered_data,
                       vdom=vdom)

    elif wireless-controller_ble-profile_data['state'] == "absent":
...
def fortios_wireless-controller(data, fos):
    ...
    methodlist = ['wireless-controller_ble-profile']
