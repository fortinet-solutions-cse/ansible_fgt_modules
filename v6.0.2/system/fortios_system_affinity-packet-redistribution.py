...
DOCUMENTATION = '''
---
module: fortios_system_affinity-packet-redistribution
short_description: Configure packet redistribution.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and affinity-packet-redistribution category.
...
- hosts: localhost
  ...
  - name: Configure packet redistribution.
    fortios_system_affinity-packet-redistribution:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_system_affinity-packet-redistribution_data(json):
...
def system_affinity-packet-redistribution(data, fos):
    vdom = data['vdom']
    system_affinity-packet-redistribution_data = data['system_affinity-packet-redistribution']
    filtered_data = filter_system_affinity-packet - \
        redistribution_data(system_affinity-packet-redistribution_data)

    if system_affinity-packet-redistribution_data['state'] == "present":
        return fos.set('system',
                       'affinity-packet-redistribution',
                       data=filtered_data,
                       vdom=vdom)

    elif system_affinity-packet-redistribution_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_affinity-packet-redistribution']
