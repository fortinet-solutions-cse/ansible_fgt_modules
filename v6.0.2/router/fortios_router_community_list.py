...
def router_community_list(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(router_community_list_data)
    filtered_data = filter_router_community_list_data(flattened_data)
    ...
    elif router_community_list_data['state'] == "absent":
