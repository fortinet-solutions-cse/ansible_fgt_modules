...
def filter_log.webtrends_setting_data(json):
...
def log.webtrends_setting(data, fos):
    ...
    if log.webtrends_setting_data['state'] == "present":
        return fos.set('log.webtrends',
                       'setting',
                       data=filtered_data,
                       vdom=vdom)

    elif log.webtrends_setting_data['state'] == "absent":
        return fos.delete('log.webtrends',
                          'setting',
...
def fortios_log.webtrends(data, fos):
    ...
    methodlist = ['log.webtrends_setting']
