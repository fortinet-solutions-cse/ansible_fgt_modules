...
def system_mac_address_table(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(system_mac_address_table_data)
    filtered_data = filter_system_mac_address_table_data(flattened_data)
    ...
    elif system_mac_address_table_data['state'] == "absent":
    ...
    fields = {
        ...
        "system_mac_address_table": {
            ...
            "options": {
                ...
                "reply-substitute": {"required": False, "type": "str"}
