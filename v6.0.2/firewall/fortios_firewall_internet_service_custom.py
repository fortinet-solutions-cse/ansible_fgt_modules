...
def firewall_internet_service_custom(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(firewall_internet_service_custom_data)
    filtered_data = filter_firewall_internet_service_custom_data(flattened_data)
