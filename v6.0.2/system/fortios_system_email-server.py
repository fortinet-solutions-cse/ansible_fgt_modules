...
DOCUMENTATION = '''
---
module: fortios_system_email-server
short_description: Configure the email server used by the FortiGate various things. For example, for sending email messages to users to support user authentication features.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and email-server category.
...
def filter_system_email-server_data(json):
...
def system_email-server(data, fos):
    vdom = data['vdom']
    system_email-server_data = data['system_email-server']
    filtered_data = filter_system_email-server_data(system_email-server_data)

    if system_email-server_data['state'] == "present":
        return fos.set('system',
                       'email-server',
                       data=filtered_data,
                       vdom=vdom)

    elif system_email-server_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_email-server']
