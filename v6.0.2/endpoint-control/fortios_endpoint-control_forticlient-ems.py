...
DOCUMENTATION = '''
---
module: fortios_endpoint-control_forticlient-ems
short_description: Configure FortiClient Enterprise Management Server (EMS) entries.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure endpoint-control feature and forticlient-ems category.
...
- hosts: localhost
  ...
  - name: Configure FortiClient Enterprise Management Server (EMS) entries.
    fortios_endpoint-control_forticlient-ems:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_endpoint-control_forticlient-ems_data(json):
...
def endpoint-control_forticlient-ems(data, fos):
    vdom = data['vdom']
    endpoint-control_forticlient-ems_data = data['endpoint-control_forticlient-ems']
    filtered_data = filter_endpoint-control_forticlient - \
        ems_data(endpoint-control_forticlient-ems_data)

    if endpoint-control_forticlient-ems_data['state'] == "present":
        return fos.set('endpoint-control',
                       'forticlient-ems',
                       data=filtered_data,
                       vdom=vdom)

    elif endpoint-control_forticlient-ems_data['state'] == "absent":
...
def fortios_endpoint-control(data, fos):
    ...
    methodlist = ['endpoint-control_forticlient-ems']
    ...
    fields = {
        ...
        "endpoint-control_forticlient-ems": {
            ...
            "options": {
                ...
                "admin-password": {"required": False, "type": "password"},
