...
def switch_controller_security_policy_802_1X(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(switch_controller_security_policy_802_1X_data)
    filtered_data = filter_switch_controller_security_policy_802_1X_data(flattened_data)
