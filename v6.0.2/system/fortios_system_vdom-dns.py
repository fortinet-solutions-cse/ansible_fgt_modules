...
DOCUMENTATION = '''
---
module: fortios_system_vdom-dns
short_description: Configure DNS servers for a non-management VDOM.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and vdom-dns category.
...
def filter_system_vdom-dns_data(json):
...
def system_vdom-dns(data, fos):
    vdom = data['vdom']
    system_vdom-dns_data = data['system_vdom-dns']
    filtered_data = filter_system_vdom-dns_data(system_vdom-dns_data)

    if system_vdom-dns_data['state'] == "present":
        return fos.set('system',
                       'vdom-dns',
                       data=filtered_data,
                       vdom=vdom)

    elif system_vdom-dns_data['state'] == "absent":
