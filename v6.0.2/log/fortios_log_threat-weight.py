...
DOCUMENTATION = '''
---
module: fortios_log_threat-weight
short_description: Configure threat weight settings.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure log feature and threat-weight category.
...
def filter_log_threat-weight_data(json):
...
def log_threat-weight(data, fos):
    vdom = data['vdom']
    log_threat-weight_data = data['log_threat-weight']
    filtered_data = filter_log_threat-weight_data(log_threat-weight_data)

    if log_threat-weight_data['state'] == "present":
        return fos.set('log',
                       'threat-weight',
                       data=filtered_data,
                       vdom=vdom)

    elif log_threat-weight_data['state'] == "absent":
