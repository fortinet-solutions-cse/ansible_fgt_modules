...
DOCUMENTATION = '''
---
module: fortios_firewall_proxy-address
short_description: Web proxy address configuration.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure firewall feature and proxy-address category.
...
- hosts: localhost
  ...
  - name: Web proxy address configuration.
    fortios_firewall_proxy-address:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_firewall_proxy-address_data(json):
...
def firewall_proxy-address(data, fos):
    vdom = data['vdom']
    firewall_proxy-address_data = data['firewall_proxy-address']
    filtered_data = filter_firewall_proxy - \
        address_data(firewall_proxy-address_data)

    if firewall_proxy-address_data['state'] == "present":
        return fos.set('firewall',
                       'proxy-address',
                       data=filtered_data,
                       vdom=vdom)

    elif firewall_proxy-address_data['state'] == "absent":
...
def fortios_firewall(data, fos):
    ...
    methodlist = ['firewall_proxy-address']
