...
def system_replacemsg_auth(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(system_replacemsg_auth_data)
    filtered_data = filter_system_replacemsg_auth_data(flattened_data)
    if system_replacemsg_auth_data['state'] == "present":
        return fos.set('system.replacemsg',
                       'auth',
                       data=filtered_data,
                       vdom=vdom)

    elif system_replacemsg_auth_data['state'] == "absent":
...
def fortios_system_replacemsg(data, fos):
    ...
    methodlist = ['system_replacemsg_auth']
