...
DOCUMENTATION = '''
---
module: fortios_system_link-monitor
short_description: Configure Link Health Monitor.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and link-monitor category.
...
def filter_system_link-monitor_data(json):
...
def system_link-monitor(data, fos):
    vdom = data['vdom']
    system_link-monitor_data = data['system_link-monitor']
    filtered_data = filter_system_link-monitor_data(system_link-monitor_data)

    if system_link-monitor_data['state'] == "present":
        return fos.set('system',
                       'link-monitor',
                       data=filtered_data,
                       vdom=vdom)

    elif system_link-monitor_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_link-monitor']
    ...
    fields = {
        ...
        "system_link-monitor": {
            ...
            "options": {
                ...
                "gateway-ip": {"required": False, "type": "ipv4-address-any"},
                "gateway-ip6": {"required": False, "type": "ipv6-address"},
                ...
                "source-ip": {"required": False, "type": "ipv4-address-any"},
