...
DOCUMENTATION = '''
---
module: fortios_webfilter_ips-urlfilter-setting
short_description: Configure IPS URL filter settings.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure webfilter feature and ips-urlfilter-setting category.
...
- hosts: localhost
  ...
  - name: Configure IPS URL filter settings.
    fortios_webfilter_ips-urlfilter-setting:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_webfilter_ips-urlfilter-setting_data(json):
...
def webfilter_ips-urlfilter-setting(data, fos):
    vdom = data['vdom']
    webfilter_ips-urlfilter-setting_data = data['webfilter_ips-urlfilter-setting']
    filtered_data = filter_webfilter_ips-urlfilter - \
        setting_data(webfilter_ips-urlfilter-setting_data)

    if webfilter_ips-urlfilter-setting_data['state'] == "present":
        return fos.set('webfilter',
                       'ips-urlfilter-setting',
                       data=filtered_data,
                       vdom=vdom)

    elif webfilter_ips-urlfilter-setting_data['state'] == "absent":
...
def fortios_webfilter(data, fos):
    ...
    methodlist = ['webfilter_ips-urlfilter-setting']
