...
DOCUMENTATION = '''
---
module: fortios_log.fortianalyzer_override-setting
short_description: Override FortiAnalyzer settings.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure log.fortianalyzer feature and override-setting category.
...
- hosts: localhost
  ...
  - name: Override FortiAnalyzer settings.
    fortios_log.fortianalyzer_override-setting:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_log.fortianalyzer_override-setting_data(json):
...
def log.fortianalyzer_override-setting(data, fos):
    vdom = data['vdom']
    log.fortianalyzer_override-setting_data = data['log.fortianalyzer_override-setting']
    filtered_data = filter_log.fortianalyzer_override - \
        setting_data(log.fortianalyzer_override-setting_data)

    if log.fortianalyzer_override-setting_data['state'] == "present":
        return fos.set('log.fortianalyzer',
                       'override-setting',
                       data=filtered_data,
                       vdom=vdom)

    elif log.fortianalyzer_override-setting_data['state'] == "absent":
...
def fortios_log.fortianalyzer(data, fos):
    ...
    methodlist = ['log.fortianalyzer_override-setting']
