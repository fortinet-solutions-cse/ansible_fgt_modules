...
DOCUMENTATION = '''
---
module: fortios_router_prefix-list
short_description: Configure IPv4 prefix lists.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure router feature and prefix-list category.
...
def filter_router_prefix-list_data(json):
...
def router_prefix-list(data, fos):
    vdom = data['vdom']
    router_prefix-list_data = data['router_prefix-list']
    filtered_data = filter_router_prefix-list_data(router_prefix-list_data)

    if router_prefix-list_data['state'] == "present":
        return fos.set('router',
                       'prefix-list',
                       data=filtered_data,
                       vdom=vdom)

    elif router_prefix-list_data['state'] == "absent":
