...
DOCUMENTATION = '''
---
module: fortios_log.fortianalyzer2_filter
short_description: Filters for FortiAnalyzer.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure log.fortianalyzer2 feature and filter category.
...
def filter_log.fortianalyzer2_filter_data(json):
...
def log.fortianalyzer2_filter(data, fos):
    vdom = data['vdom']
    log.fortianalyzer2_filter_data = data['log.fortianalyzer2_filter']
    filtered_data = filter_log.fortianalyzer2_filter_data(
        log.fortianalyzer2_filter_data)

    if log.fortianalyzer2_filter_data['state'] == "present":
        return fos.set('log.fortianalyzer2',
                       'filter',
                       data=filtered_data,
                       vdom=vdom)

    elif log.fortianalyzer2_filter_data['state'] == "absent":
        return fos.delete('log.fortianalyzer2',
                          'filter',
...
def fortios_log.fortianalyzer2(data, fos):
    ...
    methodlist = ['log.fortianalyzer2_filter']
