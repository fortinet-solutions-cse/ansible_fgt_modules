...
DOCUMENTATION = '''
---
module: fortios_system.replacemsg_ftp
short_description: Replacement messages in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system.replacemsg feature and ftp category.
...
def filter_system.replacemsg_ftp_data(json):
...
def system.replacemsg_ftp(data, fos):
    vdom = data['vdom']
    system.replacemsg_ftp_data = data['system.replacemsg_ftp']
    filtered_data = filter_system.replacemsg_ftp_data(system.replacemsg_ftp_data)
    if system.replacemsg_ftp_data['state'] == "present":
        return fos.set('system.replacemsg',
                       'ftp',
                       data=filtered_data,
                       vdom=vdom)

    elif system.replacemsg_ftp_data['state'] == "absent":
...
def fortios_system.replacemsg(data, fos):
    ...
    methodlist = ['system.replacemsg_ftp']
