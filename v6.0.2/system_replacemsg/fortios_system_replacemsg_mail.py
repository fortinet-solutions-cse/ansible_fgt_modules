...
def filter_system_replacemsg_mail_data(json):
...
def system_replacemsg_mail(data, fos):
    vdom = data['vdom']
    system_replacemsg_mail_data = data['system_replacemsg_mail']
    flattened_data = flatten_multilists_attributes(system_replacemsg_mail_data)
    filtered_data = filter_system_replacemsg_mail_data(flattened_data)
    if system_replacemsg_mail_data['state'] == "present":
        return fos.set('system.replacemsg',
                       'mail',
                       data=filtered_data,
                       vdom=vdom)

    elif system_replacemsg_mail_data['state'] == "absent":
