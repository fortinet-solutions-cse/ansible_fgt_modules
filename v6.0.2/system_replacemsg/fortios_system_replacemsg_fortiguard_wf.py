...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system_replacemsg feature and fortiguard_wf category.
...
def system_replacemsg_fortiguard_wf(data, fos):
    vdom = data['vdom']
    system_replacemsg_fortiguard_wf_data = data['system_replacemsg_fortiguard_wf']
    filtered_data = filter_system_replacemsg_fortiguard_wf_data(system_replacemsg_fortiguard_wf_data)
    if system_replacemsg_fortiguard_wf_data['state'] == "present":
        return fos.set('system.replacemsg',
                       'fortiguard-wf',
                       data=filtered_data,
                       vdom=vdom)

    elif system_replacemsg_fortiguard_wf_data['state'] == "absent":
