...
DOCUMENTATION = '''
---
module: fortios_firewall_ssl-server
short_description: Configure SSL servers.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure firewall feature and ssl-server category.
...
def filter_firewall_ssl-server_data(json):
...
def firewall_ssl-server(data, fos):
    vdom = data['vdom']
    firewall_ssl-server_data = data['firewall_ssl-server']
    filtered_data = filter_firewall_ssl-server_data(firewall_ssl-server_data)

    if firewall_ssl-server_data['state'] == "present":
        return fos.set('firewall',
                       'ssl-server',
                       data=filtered_data,
                       vdom=vdom)

    elif firewall_ssl-server_data['state'] == "absent":
...
def fortios_firewall(data, fos):
    ...
    methodlist = ['firewall_ssl-server']
