...
DOCUMENTATION = '''
---
module: fortios_system.replacemsg_fortiguard_wf
short_description: Replacement messages in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system.replacemsg feature and fortiguard_wf category.
...
def filter_system.replacemsg_fortiguard_wf_data(json):
...
def system.replacemsg_fortiguard_wf(data, fos):
    vdom = data['vdom']
    system.replacemsg_fortiguard_wf_data = data['system.replacemsg_fortiguard_wf']
    filtered_data = filter_system.replacemsg_fortiguard_wf_data(system.replacemsg_fortiguard_wf_data)
    if system.replacemsg_fortiguard_wf_data['state'] == "present":
        return fos.set('system.replacemsg',
                       'fortiguard-wf',
                       data=filtered_data,
                       vdom=vdom)

    elif system.replacemsg_fortiguard_wf_data['state'] == "absent":
...
def fortios_system.replacemsg(data, fos):
    ...
    methodlist = ['system.replacemsg_fortiguard_wf']
