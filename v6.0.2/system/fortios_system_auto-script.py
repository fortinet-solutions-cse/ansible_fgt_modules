...
DOCUMENTATION = '''
---
module: fortios_system_auto-script
short_description: Configure auto script.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and auto-script category.
...
def filter_system_auto-script_data(json):
...
def system_auto-script(data, fos):
    vdom = data['vdom']
    system_auto-script_data = data['system_auto-script']
    filtered_data = filter_system_auto-script_data(system_auto-script_data)

    if system_auto-script_data['state'] == "present":
        return fos.set('system',
                       'auto-script',
                       data=filtered_data,
                       vdom=vdom)

    elif system_auto-script_data['state'] == "absent":
