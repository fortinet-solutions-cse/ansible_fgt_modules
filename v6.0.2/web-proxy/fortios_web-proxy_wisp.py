...
DOCUMENTATION = '''
---
module: fortios_web-proxy_wisp
short_description: Configure Wireless Internet service provider (WISP) servers.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure web-proxy feature and wisp category.
...
def filter_web-proxy_wisp_data(json):
...
def web-proxy_wisp(data, fos):
    vdom = data['vdom']
    web-proxy_wisp_data = data['web-proxy_wisp']
    filtered_data = filter_web-proxy_wisp_data(web-proxy_wisp_data)

    if web-proxy_wisp_data['state'] == "present":
        return fos.set('web-proxy',
                       'wisp',
                       data=filtered_data,
                       vdom=vdom)

    elif web-proxy_wisp_data['state'] == "absent":
    ...
    fields = {
        ...
        "web-proxy_wisp": {
            ...
            "options": {
                ...
                "server-ip": {"required": False, "type": "ipv4-address-any"},
