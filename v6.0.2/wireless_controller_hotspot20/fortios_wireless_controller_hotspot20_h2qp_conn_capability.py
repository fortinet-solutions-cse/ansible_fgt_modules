...
def wireless_controller_hotspot20_h2qp_conn_capability(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(wireless_controller_hotspot20_h2qp_conn_capability_data)
    filtered_data = filter_wireless_controller_hotspot20_h2qp_conn_capability_data(flattened_data)
    if wireless_controller_hotspot20_h2qp_conn_capability_data['state'] == "present":
        return fos.set('wireless-controller.hotspot20',
                       'h2qp-conn-capability',
                       data=filtered_data,
                       vdom=vdom)

    elif wireless_controller_hotspot20_h2qp_conn_capability_data['state'] == "absent":
