...
description:
    - This module is able to configure a FortiGate or FortiOS by allowing the
      user to set and modify system feature and vdom_radius_server category.
...
def filter_system_vdom_radius_server_data(json):
...
def system_vdom_radius_server(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(system_vdom_radius_server_data)
    filtered_data = filter_system_vdom_radius_server_data(flattened_data)
    ...
    elif system_vdom_radius_server_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_vdom_radius_server']
