...
def wireless_controller_hotspot20_h2qp_operator_name(data, fos):
    ...
    flattened_data = flatten_multilists_attributes(wireless_controller_hotspot20_h2qp_operator_name_data)
    filtered_data = filter_wireless_controller_hotspot20_h2qp_operator_name_data(flattened_data)
