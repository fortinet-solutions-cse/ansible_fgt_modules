...
DOCUMENTATION = '''
---
module: fortios_system_sdn-connector
short_description: Configure connection to SDN Connector.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and sdn-connector category.
...
def filter_system_sdn-connector_data(json):
...
def system_sdn-connector(data, fos):
    vdom = data['vdom']
    system_sdn-connector_data = data['system_sdn-connector']
    filtered_data = filter_system_sdn-connector_data(system_sdn-connector_data)

    if system_sdn-connector_data['state'] == "present":
        return fos.set('system',
                       'sdn-connector',
                       data=filtered_data,
                       vdom=vdom)

    elif system_sdn-connector_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_sdn-connector']
    ...
    fields = {
        ...
        "system_sdn-connector": {
            ...
            "options": {
                ...
                "client-secret": {"required": False, "type": "password"},
                ...
                "key-passwd": {"required": False, "type": "password"},
                "name": {"required": True, "type": "str"},
                ...
                "secret-key": {"required": False, "type": "password"},
