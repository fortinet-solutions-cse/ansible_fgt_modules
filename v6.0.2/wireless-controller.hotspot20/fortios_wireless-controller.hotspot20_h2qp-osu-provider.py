...
DOCUMENTATION = '''
---
module: fortios_wireless-controller.hotspot20_h2qp-osu-provider
short_description: Configure online sign up (OSU) provider list.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure wireless-controller.hotspot20 feature and h2qp-osu-provider category.
...
- hosts: localhost
  ...
  - name: Configure online sign up (OSU) provider list.
    fortios_wireless-controller.hotspot20_h2qp-osu-provider:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_wireless-controller.hotspot20_h2qp-osu-provider_data(json):
...
def wireless-controller.hotspot20_h2qp-osu-provider(data, fos):
    vdom = data['vdom']
    wireless-controller.hotspot20_h2qp-osu-provider_data = data['wireless-controller.hotspot20_h2qp-osu-provider']
    filtered_data = filter_wireless-controller.hotspot20_h2qp-osu - \
        provider_data(wireless-controller.hotspot20_h2qp-osu-provider_data)

    if wireless-controller.hotspot20_h2qp - \
            osu-provider_data['state'] == "present":
        return fos.set('wireless-controller.hotspot20',
                       'h2qp-osu-provider',
                       data=filtered_data,
                       vdom=vdom)

    elif wireless-controller.hotspot20_h2qp-osu-provider_data['state'] == "absent":
...
def fortios_wireless-controller.hotspot20(data, fos):
    ...
    methodlist = ['wireless-controller.hotspot20_h2qp-osu-provider']
            ...
            "options": {
                ...
                "service-description": {"required": False, "type": "list",
                                        "options": {
                                            ...
                                            "service-id": {"required": False, "type": "int"}
                                        }}
