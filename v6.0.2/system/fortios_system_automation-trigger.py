...
DOCUMENTATION = '''
---
module: fortios_system_automation-trigger
short_description: Trigger for automation stitches.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and automation-trigger category.
...
- hosts: localhost
  ...
  - name: Trigger for automation stitches.
    fortios_system_automation-trigger:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_system_automation-trigger_data(json):
...
def system_automation-trigger(data, fos):
    vdom = data['vdom']
    system_automation-trigger_data = data['system_automation-trigger']
    filtered_data = filter_system_automation - \
        trigger_data(system_automation-trigger_data)

    if system_automation-trigger_data['state'] == "present":
        return fos.set('system',
                       'automation-trigger',
                       data=filtered_data,
                       vdom=vdom)

    elif system_automation-trigger_data['state'] == "absent":
...
def fortios_system(data, fos):
    ...
    methodlist = ['system_automation-trigger']
