...
DOCUMENTATION = '''
---
module: fortios_switch-controller_switch-group
short_description: Configure FortiSwitch switch groups.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure switch-controller feature and switch-group category.
...
- hosts: localhost
  ...
  - name: Configure FortiSwitch switch groups.
    fortios_switch-controller_switch-group:
      host:  "{{  host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{  vdom }}"
...
def filter_switch-controller_switch-group_data(json):
...
def switch-controller_switch-group(data, fos):
    vdom = data['vdom']
    switch-controller_switch-group_data = data['switch-controller_switch-group']
    filtered_data = filter_switch-controller_switch - \
        group_data(switch-controller_switch-group_data)

    if switch-controller_switch-group_data['state'] == "present":
        return fos.set('switch-controller',
                       'switch-group',
                       data=filtered_data,
                       vdom=vdom)

    elif switch-controller_switch-group_data['state'] == "absent":
...
def fortios_switch-controller(data, fos):
    ...
    methodlist = ['switch-controller_switch-group']
