...
DOCUMENTATION = '''
---
module: fortios_system.replacemsg_ec
short_description: Replacement messages.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system.replacemsg feature and ec category.
...
def filter_system.replacemsg_ec_data(json):
...
def system.replacemsg_ec(data, fos):
    vdom = data['vdom']
    system.replacemsg_ec_data = data['system.replacemsg_ec']
    filtered_data = filter_system.replacemsg_ec_data(system.replacemsg_ec_data)
    if system.replacemsg_ec_data['state'] == "present":
        return fos.set('system.replacemsg',
                       'ec',
                       data=filtered_data,
                       vdom=vdom)

    elif system.replacemsg_ec_data['state'] == "absent":
...
def fortios_system.replacemsg(data, fos):
    ...
    methodlist = ['system.replacemsg_ec']
