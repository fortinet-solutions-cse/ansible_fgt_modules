...
DOCUMENTATION = '''
---
module: fortios_log.fortianalyzer_override_filter
short_description: Override filters for FortiAnalyzer in Fortinet's FortiOS and FortiGate.
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure log.fortianalyzer feature and override_filter category.
...
options:
    ...
    https:
        ...
        type: bool
        default: false
    log.fortianalyzer_override_filter:
        description:
...
- hosts: localhost
  ...
  - name: Override filters for FortiAnalyzer.
    fortios_log.fortianalyzer_override_filter:
      host:  "{{ host }}"
      username: "{{ username }}"
      password: "{{ password }}"
      vdom:  "{{ vdom }}"
...
def filter_log.fortianalyzer_override_filter_data(json):
...
def log.fortianalyzer_override_filter(data, fos):
    vdom = data['vdom']
    log.fortianalyzer_override_filter_data = data['log.fortianalyzer_override_filter']
    filtered_data = filter_log.fortianalyzer_override_filter_data(log.fortianalyzer_override_filter_data)
...
def fortios_log.fortianalyzer(data, fos):
    ...
    methodlist = ['log.fortianalyzer_override_filter']
...
def main():
    ...
    is_error, has_changed, result = fortios_log.fortianalyzer(module.params, fos)
