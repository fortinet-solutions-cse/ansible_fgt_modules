...
description:
    - This module is able to configure a FortiGate or FortiOS by
      allowing the user to configure system feature and console category.
...
def filter_system_console_data(json):
    option_list = ['baudrate', 'login', 'mode',
                   'output']
    dictionary = {}
...
def system_console(data, fos):
    ...
    if system_console_data['state'] == "present":
        return fos.set('system',
                       'console',
                       data=filtered_data,
                       vdom=vdom)

    elif system_console_data['state'] == "absent":
